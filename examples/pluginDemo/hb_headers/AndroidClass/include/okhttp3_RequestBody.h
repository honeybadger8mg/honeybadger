...
#ifndef HONEYBADGER_OKHTTP3_REQUESTBODY_H
#define HONEYBADGER_OKHTTP3_REQUESTBODY_H
#include "ISimulateClass.h"



class okhttp3_RequestBody : public ISimulateClass {
public:
    okhttp3_RequestBody(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_REQUESTBODY_H

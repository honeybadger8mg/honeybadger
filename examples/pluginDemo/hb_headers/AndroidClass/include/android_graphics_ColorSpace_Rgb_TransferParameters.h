...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_RGB_TRANSFERPARAMETERS_H
#define HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_RGB_TRANSFERPARAMETERS_H
...
class android_graphics_ColorSpace_Rgb_TransferParameters : public ISimulateClass {
public:
    android_graphics_ColorSpace_Rgb_TransferParameters(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_RGB_TRANSFERPARAMETERS_H

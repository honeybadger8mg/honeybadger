...
#ifndef HONEYBADGER_ANDROID_ANIMATION_PROPERTYVALUESHOLDER_H
#define HONEYBADGER_ANDROID_ANIMATION_PROPERTYVALUESHOLDER_H
...
class android_animation_PropertyValuesHolder : public ISimulateClass {
public:
    android_animation_PropertyValuesHolder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_ANIMATION_PROPERTYVALUESHOLDER_H

...
#ifndef HONEYBADGER_ARRAY_JAVA_LANG_STRING_H
#define HONEYBADGER_ARRAY_JAVA_LANG_STRING_H

#include "ISimulateClass.h"
#include "java_lang_String.h"
#include <vector>

class Array_java_lang_String   : public ISimulateClass {
public:
    Array_java_lang_String(HB::EntryInterface *pDebugger);
    ...
    void InsertNewString(java_lang_String *pNew);
...
private:
    ...
    vector<java_lang_String *> m_vecStacks;
...
#endif //HONEYBADGER_ARRAY_JAVA_LANG_STRING_H

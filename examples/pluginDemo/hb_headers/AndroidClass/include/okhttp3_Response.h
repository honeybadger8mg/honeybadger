...
#ifndef HONEYBADGER_OKHTTP3_RESPONSE_H
#define HONEYBADGER_OKHTTP3_RESPONSE_H
#include "ISimulateClass.h"



class okhttp3_Response : public ISimulateClass {
public:
    okhttp3_Response(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_RESPONSE_H

...
#ifndef HONEYBADGER_JAVA_LANG_REFLECT_METHOD_H
#define HONEYBADGER_JAVA_LANG_REFLECT_METHOD_H

#include "ISimulateClass.h"



class java_lang_reflect_Method : public ISimulateClass {
public:
    java_lang_reflect_Method(HB::EntryInterface *pDebugger);
...
public:
    void SetMethodInfo(ISimulateClass *pOwner, string strMethodName);
...
#endif //HONEYBADGER_JAVA_LANG_REFLECT_METHOD_H

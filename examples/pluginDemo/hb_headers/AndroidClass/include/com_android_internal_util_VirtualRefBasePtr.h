...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_UTIL_VIRTUALREFBASEPTR_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_UTIL_VIRTUALREFBASEPTR_H
...
class com_android_internal_util_VirtualRefBasePtr : public ISimulateClass {
public:
    com_android_internal_util_VirtualRefBasePtr(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_UTIL_VIRTUALREFBASEPTR_H

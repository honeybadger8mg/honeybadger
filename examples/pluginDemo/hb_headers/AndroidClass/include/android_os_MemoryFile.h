...
#ifndef HONEYBADGER_ANDROID_OS_MEMORYFILE_H
#define HONEYBADGER_ANDROID_OS_MEMORYFILE_H
...
class android_os_MemoryFile : public ISimulateClass {
public:
    android_os_MemoryFile(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_MEMORYFILE_H

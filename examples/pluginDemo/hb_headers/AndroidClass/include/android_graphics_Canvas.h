...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_CANVAS_H
#define HONEYBADGER_ANDROID_GRAPHICS_CANVAS_H
...
class android_graphics_Canvas : public ISimulateClass {
public:
    android_graphics_Canvas(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_CANVAS_H

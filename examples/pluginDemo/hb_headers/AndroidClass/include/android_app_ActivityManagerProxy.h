...
#ifndef HONEYBADGER_ANDROID_APP_ACTIVITYMANAGERPROXY_H
#define HONEYBADGER_ANDROID_APP_ACTIVITYMANAGERPROXY_H

#include "ISimulateClass.h"
#include "EntryInterface.h"


class android_app_ActivityManagerProxy : public ISimulateClass {
public:
    android_app_ActivityManagerProxy(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_ACTIVITYMANAGERPROXY_H

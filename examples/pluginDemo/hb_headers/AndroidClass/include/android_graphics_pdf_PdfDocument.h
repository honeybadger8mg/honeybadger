...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFDOCUMENT_H
#define HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFDOCUMENT_H
...
class android_graphics_pdf_PdfDocument : public ISimulateClass {
public:
    android_graphics_pdf_PdfDocument(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFDOCUMENT_H

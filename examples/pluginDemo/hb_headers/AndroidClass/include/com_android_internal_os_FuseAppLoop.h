...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_OS_FUSEAPPLOOP_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_OS_FUSEAPPLOOP_H
...
class com_android_internal_os_FuseAppLoop : public ISimulateClass {
public:
    com_android_internal_os_FuseAppLoop(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_OS_FUSEAPPLOOP_H

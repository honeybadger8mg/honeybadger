...
#ifndef HONEYBADGER_ANDROID_OS_HWBINDER_H
#define HONEYBADGER_ANDROID_OS_HWBINDER_H
...
class android_os_HwBinder : public ISimulateClass {
public:
    android_os_HwBinder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_HWBINDER_H

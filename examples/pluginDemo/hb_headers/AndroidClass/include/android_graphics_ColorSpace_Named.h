...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_NAMED_H
#define HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_NAMED_H
...
class android_graphics_ColorSpace_Named : public ISimulateClass {
public:
    android_graphics_ColorSpace_Named(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_NAMED_H

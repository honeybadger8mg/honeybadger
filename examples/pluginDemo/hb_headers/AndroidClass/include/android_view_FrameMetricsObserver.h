...
#ifndef HONEYBADGER_ANDROID_VIEW_FRAMEMETRICSOBSERVER_H
#define HONEYBADGER_ANDROID_VIEW_FRAMEMETRICSOBSERVER_H
...
class android_view_FrameMetricsObserver : public ISimulateClass {
public:
    android_view_FrameMetricsObserver(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_FRAMEMETRICSOBSERVER_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_FRAMEDRAWINGCALLBACK_H
#define HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_FRAMEDRAWINGCALLBACK_H
...
class android_view_ThreadedRenderer_FrameDrawingCallback : public ISimulateClass {
public:
    android_view_ThreadedRenderer_FrameDrawingCallback(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_FRAMEDRAWINGCALLBACK_H

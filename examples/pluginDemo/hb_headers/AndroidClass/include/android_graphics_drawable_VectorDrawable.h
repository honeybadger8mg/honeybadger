...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_VECTORDRAWABLE_H
#define HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_VECTORDRAWABLE_H
...
class android_graphics_drawable_VectorDrawable : public ISimulateClass {
public:
    android_graphics_drawable_VectorDrawable(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_VECTORDRAWABLE_H

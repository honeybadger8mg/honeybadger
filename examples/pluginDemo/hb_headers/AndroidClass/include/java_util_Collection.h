...
#ifndef HONEYBADGER_JAVA_UTIL_COLLECTION_H
#define HONEYBADGER_JAVA_UTIL_COLLECTION_H
...
class java_util_Collection : public ISimulateClass {
public:
    java_util_Collection(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_UTIL_COLLECTION_H

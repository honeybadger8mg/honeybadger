...
#ifndef HONEYBADGER_ANDROID_VIEW_MOTIONEVENT_H
#define HONEYBADGER_ANDROID_VIEW_MOTIONEVENT_H
...
class android_view_MotionEvent : public ISimulateClass {
public:
    android_view_MotionEvent(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_MOTIONEVENT_H

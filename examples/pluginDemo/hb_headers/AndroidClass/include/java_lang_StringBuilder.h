...
#ifndef HONEYBADGER_JAVA_LANG_STRINGBUILDER_H
#define HONEYBADGER_JAVA_LANG_STRINGBUILDER_H

#include "ISimulateClass.h"



class java_lang_StringBuilder : public ISimulateClass {
public:
    java_lang_StringBuilder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_STRINGBUILDER_H

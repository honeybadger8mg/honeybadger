...
#ifndef HONEYBADGER_ANDROID_CONTENT_SHAREDPREFERENCES_EDITOR_H
#define HONEYBADGER_ANDROID_CONTENT_SHAREDPREFERENCES_EDITOR_H
#include "ISimulateClass.h"




class android_content_SharedPreferences_Editor : public ISimulateClass {
public:
    android_content_SharedPreferences_Editor(HB::EntryInterface *pDebugger);
...
public: // 自有属性
    void SetSpFilePath(string strSpPath); // 自动创建路径
...
private:
    ...
    string m_strSpPath; // 由路径创建
};


#endif //HONEYBADGER_ANDROID_CONTENT_SHAREDPREFERENCES_EDITOR_H

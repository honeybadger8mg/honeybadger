...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_REGION_H
#define HONEYBADGER_ANDROID_GRAPHICS_REGION_H
...
class android_graphics_Region : public ISimulateClass {
public:
    android_graphics_Region(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_REGION_H

...
#ifndef HONEYBADGER_ANDROID_OS_LOOPER_H
#define HONEYBADGER_ANDROID_OS_LOOPER_H
...
class android_os_Looper : public ISimulateClass {
public:
    android_os_Looper(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_LOOPER_H

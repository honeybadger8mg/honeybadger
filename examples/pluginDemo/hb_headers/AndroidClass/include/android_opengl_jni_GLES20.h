...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_GLES20_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_GLES20_H
...
class android_opengl_jni_GLES20 : public ISimulateClass {
public:
    android_opengl_jni_GLES20(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_GLES20_H

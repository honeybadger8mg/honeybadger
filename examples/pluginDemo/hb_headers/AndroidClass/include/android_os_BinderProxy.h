...
#ifndef HONEYBADGER_ANDROID_OS_BINDERPROXY_H
#define HONEYBADGER_ANDROID_OS_BINDERPROXY_H
...
class android_os_BinderProxy : public ISimulateClass {
public:
    android_os_BinderProxy(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_BINDERPROXY_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_INPUTDEVICE_H
#define HONEYBADGER_ANDROID_VIEW_INPUTDEVICE_H
...
class android_view_InputDevice : public ISimulateClass {
public:
    android_view_InputDevice(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_INPUTDEVICE_H

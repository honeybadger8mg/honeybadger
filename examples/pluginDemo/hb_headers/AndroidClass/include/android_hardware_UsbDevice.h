...
#ifndef HONEYBADGER_ANDROID_HARDWARE_USBDEVICE_H
#define HONEYBADGER_ANDROID_HARDWARE_USBDEVICE_H
...
class android_hardware_UsbDevice : public ISimulateClass {
public:
    android_hardware_UsbDevice(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_USBDEVICE_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_POINTERICON_H
#define HONEYBADGER_ANDROID_VIEW_POINTERICON_H
...
class android_view_PointerIcon : public ISimulateClass {
public:
    android_view_PointerIcon(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_POINTERICON_H

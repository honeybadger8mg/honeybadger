...
#ifndef HONEYBADGER_ANDROID_VIEW_KEYCHARACTERMAP_H
#define HONEYBADGER_ANDROID_VIEW_KEYCHARACTERMAP_H
...
class android_view_KeyCharacterMap : public ISimulateClass {
public:
    android_view_KeyCharacterMap(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_KEYCHARACTERMAP_H

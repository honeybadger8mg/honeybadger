...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_BITMAPREGIONDECODER_H
#define HONEYBADGER_ANDROID_GRAPHICS_BITMAPREGIONDECODER_H
...
class android_graphics_BitmapRegionDecoder : public ISimulateClass {
public:
    android_graphics_BitmapRegionDecoder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_BITMAPREGIONDECODER_H

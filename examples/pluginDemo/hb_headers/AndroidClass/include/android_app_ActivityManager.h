...
#ifndef HONEYBADGER_ANDROID_APP_ACTIVITYMANAGER_H
#define HONEYBADGER_ANDROID_APP_ACTIVITYMANAGER_H
...
class android_app_ActivityManager : public ISimulateClass {
public:
    android_app_ActivityManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_ACTIVITYMANAGER_H

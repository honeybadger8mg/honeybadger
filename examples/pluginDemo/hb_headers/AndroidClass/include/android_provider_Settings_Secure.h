...
#ifndef HONEYBADGER_ANDROID_PROVIDER_SETTINGS_SECURE_H
#define HONEYBADGER_ANDROID_PROVIDER_SETTINGS_SECURE_H

#include "ISimulateClass.h"



class android_provider_Settings_Secure  : public ISimulateClass {
public:
    android_provider_Settings_Secure(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_PROVIDER_SETTINGS_SECURE_H

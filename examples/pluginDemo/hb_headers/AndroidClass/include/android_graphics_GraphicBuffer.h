...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_GRAPHICBUFFER_H
#define HONEYBADGER_ANDROID_GRAPHICS_GRAPHICBUFFER_H
...
class android_graphics_GraphicBuffer : public ISimulateClass {
public:
    android_graphics_GraphicBuffer(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_GRAPHICBUFFER_H

...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_SURFACETEXTURE_H
#define HONEYBADGER_ANDROID_GRAPHICS_SURFACETEXTURE_H
...
class android_graphics_SurfaceTexture : public ISimulateClass {
public:
    android_graphics_SurfaceTexture(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_SURFACETEXTURE_H

...
#ifndef HONEYBADGER_OKHTTP3_INTERCEPTOR_CHAIN_H
#define HONEYBADGER_OKHTTP3_INTERCEPTOR_CHAIN_H
#include "ISimulateClass.h"



class okhttp3_Interceptor_Chain : public ISimulateClass {
public:
    okhttp3_Interceptor_Chain(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_INTERCEPTOR_CHAIN_H

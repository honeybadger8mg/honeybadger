...
#ifndef HONEYBADGER_ANDROID_HARDWARE_SOUNDTRIGGER_H
#define HONEYBADGER_ANDROID_HARDWARE_SOUNDTRIGGER_H
...
class android_hardware_SoundTrigger : public ISimulateClass {
public:
    android_hardware_SoundTrigger(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_SOUNDTRIGGER_H

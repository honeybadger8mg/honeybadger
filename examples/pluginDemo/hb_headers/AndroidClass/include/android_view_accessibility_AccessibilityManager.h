...
#ifndef HONEYBADGER_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYMANAGER_H
#define HONEYBADGER_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYMANAGER_H
...
class android_view_accessibility_AccessibilityManager : public ISimulateClass {
public:
    android_view_accessibility_AccessibilityManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_ACCESSIBILITY_ACCESSIBILITYMANAGER_H

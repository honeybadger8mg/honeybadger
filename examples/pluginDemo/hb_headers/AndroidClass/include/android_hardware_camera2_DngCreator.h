...
#ifndef HONEYBADGER_ANDROID_HARDWARE_CAMERA2_DNGCREATOR_H
#define HONEYBADGER_ANDROID_HARDWARE_CAMERA2_DNGCREATOR_H
...
class android_hardware_camera2_DngCreator : public ISimulateClass {
public:
    android_hardware_camera2_DngCreator(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_CAMERA2_DNGCREATOR_H

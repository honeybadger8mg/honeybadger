...
#ifndef HONEYBADGER_JAVA_UTIL_UUID_H
#define HONEYBADGER_JAVA_UTIL_UUID_H

#include "ISimulateClass.h"



class java_util_UUID : public ISimulateClass {
public:
    java_util_UUID(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_UTIL_UUID_H

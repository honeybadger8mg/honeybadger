...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_OS_CLASSLOADERFACTORY_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_OS_CLASSLOADERFACTORY_H
...
class com_android_internal_os_ClassLoaderFactory : public ISimulateClass {
public:
    com_android_internal_os_ClassLoaderFactory(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_OS_CLASSLOADERFACTORY_H

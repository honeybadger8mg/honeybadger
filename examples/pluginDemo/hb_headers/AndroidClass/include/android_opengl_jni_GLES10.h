...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_GLES10_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_GLES10_H
...
class android_opengl_jni_GLES10 : public ISimulateClass {
public:
    android_opengl_jni_GLES10(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_GLES10_H

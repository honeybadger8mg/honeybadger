...
#ifndef HONEYBADGER_ANDROID_OS_BATTERYMANAGER_H
#define HONEYBADGER_ANDROID_OS_BATTERYMANAGER_H

#include "ISimulateClass.h"



class android_os_BatteryManager : public ISimulateClass {
public:
    android_os_BatteryManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_BATTERYMANAGER_H

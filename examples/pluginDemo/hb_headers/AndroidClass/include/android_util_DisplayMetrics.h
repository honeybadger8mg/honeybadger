...
#ifndef HONEYBADGER_ANDROID_UTIL_DISPLAYMETRICS_H
#define HONEYBADGER_ANDROID_UTIL_DISPLAYMETRICS_H

#include "ISimulateClass.h"



class android_util_DisplayMetrics : public ISimulateClass {
public:
    android_util_DisplayMetrics(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_UTIL_DISPLAYMETRICS_H

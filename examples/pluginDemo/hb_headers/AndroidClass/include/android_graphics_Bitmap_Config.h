...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_BITMAP_CONFIG_H
#define HONEYBADGER_ANDROID_GRAPHICS_BITMAP_CONFIG_H
...
class android_graphics_Bitmap_Config : public ISimulateClass {
public:
    android_graphics_Bitmap_Config(HB::EntryInterface *pDebugger);
...
public:
    uint32_t ALPHA_8{0};
    uint32_t RGB_565{0};
    uint32_t ARGB_4444{0};
    uint32_t ARGB_8888{0};
    uint32_t RGBA_F16{0};
    uint32_t HARDWARE{0};

    uint32_t nativeInt{0};
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_BITMAP_CONFIG_H

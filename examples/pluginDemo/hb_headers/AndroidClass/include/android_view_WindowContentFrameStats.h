...
#ifndef HONEYBADGER_ANDROID_VIEW_WINDOWCONTENTFRAMESTATS_H
#define HONEYBADGER_ANDROID_VIEW_WINDOWCONTENTFRAMESTATS_H
...
class android_view_WindowContentFrameStats : public ISimulateClass {
public:
    android_view_WindowContentFrameStats(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_WINDOWCONTENTFRAMESTATS_H

...
#ifndef HONEYBADGER_ANDROID_SERVER_NETWORKMANAGEMENTSOCKETTAGGER_H
#define HONEYBADGER_ANDROID_SERVER_NETWORKMANAGEMENTSOCKETTAGGER_H
...
class android_server_NetworkManagementSocketTagger : public ISimulateClass {
public:
    android_server_NetworkManagementSocketTagger(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_SERVER_NETWORKMANAGEMENTSOCKETTAGGER_H

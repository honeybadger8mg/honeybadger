...
#ifndef HONEYBADGER_JAVA_NIO_CHARSET_CHARSET_H
#define HONEYBADGER_JAVA_NIO_CHARSET_CHARSET_H

#include "ISimulateClass.h"


class java_nio_charset_Charset : public ISimulateClass {
public:
    java_nio_charset_Charset(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_NIO_CHARSET_CHARSET_H

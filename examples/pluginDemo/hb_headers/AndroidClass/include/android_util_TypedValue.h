...
#ifndef HONEYBADGER_ANDROID_UTIL_TYPEDVALUE_H
#define HONEYBADGER_ANDROID_UTIL_TYPEDVALUE_H
...
class android_util_TypedValue : public ISimulateClass {
public:
    android_util_TypedValue(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_UTIL_TYPEDVALUE_H

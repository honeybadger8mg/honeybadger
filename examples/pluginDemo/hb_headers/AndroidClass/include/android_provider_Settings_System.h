...
#ifndef HONEYBADGER_ANDROID_PROVIDER_SETTINGS_SYSTEM_H
#define HONEYBADGER_ANDROID_PROVIDER_SETTINGS_SYSTEM_H
...
class android_provider_Settings_System : public ISimulateClass {
public:
    android_provider_Settings_System(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_PROVIDER_SETTINGS_SYSTEM_H

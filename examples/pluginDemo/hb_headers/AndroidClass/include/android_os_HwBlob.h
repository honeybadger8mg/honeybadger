...
#ifndef HONEYBADGER_ANDROID_OS_HWBLOB_H
#define HONEYBADGER_ANDROID_OS_HWBLOB_H
...
class android_os_HwBlob : public ISimulateClass {
public:
    android_os_HwBlob(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_HWBLOB_H

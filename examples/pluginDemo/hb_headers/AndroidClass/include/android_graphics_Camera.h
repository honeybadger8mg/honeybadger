...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_CAMERA_H
#define HONEYBADGER_ANDROID_GRAPHICS_CAMERA_H
...
class android_graphics_Camera : public ISimulateClass {
public:
    android_graphics_Camera(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_CAMERA_H

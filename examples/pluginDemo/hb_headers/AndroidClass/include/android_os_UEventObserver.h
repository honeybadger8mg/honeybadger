...
#ifndef HONEYBADGER_ANDROID_OS_UEVENTOBSERVER_H
#define HONEYBADGER_ANDROID_OS_UEVENTOBSERVER_H
...
class android_os_UEventObserver : public ISimulateClass {
public:
    android_os_UEventObserver(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_UEVENTOBSERVER_H

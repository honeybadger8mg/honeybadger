...
#ifndef HONEYBADGER_JAVA_NIO_NIOACCESS_H
#define HONEYBADGER_JAVA_NIO_NIOACCESS_H
...
class java_nio_NIOAccess : public ISimulateClass {
public:
    java_nio_NIOAccess(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_NIO_NIOACCESS_H

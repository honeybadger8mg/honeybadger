...
#ifndef HONEYBADGER_JAVA_LANG_RUNNABLE_H
#define HONEYBADGER_JAVA_LANG_RUNNABLE_H
...
class java_lang_Runnable : public ISimulateClass {
public:
    java_lang_Runnable(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_RUNNABLE_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_INPUTEVENTRECEIVER_H
#define HONEYBADGER_ANDROID_VIEW_INPUTEVENTRECEIVER_H
...
class android_view_InputEventReceiver : public ISimulateClass {
public:
    android_view_InputEventReceiver(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_INPUTEVENTRECEIVER_H

...
#ifndef HONEYBADGER_ANDROID_OS_TRACE_H
#define HONEYBADGER_ANDROID_OS_TRACE_H
...
class android_os_Trace : public ISimulateClass {
public:
    android_os_Trace(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_TRACE_H

...
#ifndef HONEYBADGER_ANDROID_NET_WIFI_WIFIMANAGER_H
#define HONEYBADGER_ANDROID_NET_WIFI_WIFIMANAGER_H

#include "ISimulateClass.h"



class android_net_wifi_WifiManager : public ISimulateClass {
public:
    android_net_wifi_WifiManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_NET_WIFI_WIFIMANAGER_H

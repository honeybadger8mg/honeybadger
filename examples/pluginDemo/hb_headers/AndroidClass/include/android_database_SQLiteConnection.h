...
#ifndef HONEYBADGER_ANDROID_DATABASE_SQLITECONNECTION_H
#define HONEYBADGER_ANDROID_DATABASE_SQLITECONNECTION_H
...
class android_database_SQLiteConnection : public ISimulateClass {
public:
    android_database_SQLiteConnection(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_DATABASE_SQLITECONNECTION_H

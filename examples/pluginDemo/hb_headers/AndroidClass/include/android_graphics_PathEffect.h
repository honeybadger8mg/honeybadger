...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_PATHEFFECT_H
#define HONEYBADGER_ANDROID_GRAPHICS_PATHEFFECT_H
...
class android_graphics_PathEffect : public ISimulateClass {
public:
    android_graphics_PathEffect(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_PATHEFFECT_H

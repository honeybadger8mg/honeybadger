...
#ifndef HONEYBADGER_ANDROID_APP_BACKUP_FULLBACKUP_H
#define HONEYBADGER_ANDROID_APP_BACKUP_FULLBACKUP_H
...
class android_app_backup_FullBackup : public ISimulateClass {
public:
    android_app_backup_FullBackup(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_BACKUP_FULLBACKUP_H

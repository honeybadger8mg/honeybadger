...
#ifndef HONEYBADGER_ANDROID_OS_GRAPHICSENVIRONMENT_H
#define HONEYBADGER_ANDROID_OS_GRAPHICSENVIRONMENT_H
...
class android_os_GraphicsEnvironment : public ISimulateClass {
public:
    android_os_GraphicsEnvironment(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_GRAPHICSENVIRONMENT_H

...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_PATH_H
#define HONEYBADGER_ANDROID_GRAPHICS_PATH_H
...
class android_graphics_Path : public ISimulateClass {
public:
    android_graphics_Path(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_PATH_H

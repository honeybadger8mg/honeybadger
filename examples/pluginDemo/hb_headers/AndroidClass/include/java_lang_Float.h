...
#ifndef HONEYBADGER_JAVA_LANG_FLOAT_H
#define HONEYBADGER_JAVA_LANG_FLOAT_H

#include "ISimulateClass.h"



class java_lang_Float : public ISimulateClass {
public:
    java_lang_Float(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_FLOAT_H

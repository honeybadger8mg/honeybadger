...
#ifndef HONEYBADGER_ANDROID_WEBKIT_WEBSETTINGS_H
#define HONEYBADGER_ANDROID_WEBKIT_WEBSETTINGS_H
...
class android_webkit_WebSettings : public ISimulateClass {
public:
    android_webkit_WebSettings(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_WEBKIT_WEBSETTINGS_H

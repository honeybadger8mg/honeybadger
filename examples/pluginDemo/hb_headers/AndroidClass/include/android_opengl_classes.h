...
#ifndef HONEYBADGER_ANDROID_OPENGL_CLASSES_H
#define HONEYBADGER_ANDROID_OPENGL_CLASSES_H
...
class android_opengl_classes : public ISimulateClass {
public:
    android_opengl_classes(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_CLASSES_H

...
#ifndef HONEYBADGER_JAVA_LANG_BOOLEAN_H
#define HONEYBADGER_JAVA_LANG_BOOLEAN_H

#include "ISimulateClass.h"



class java_lang_Boolean : public ISimulateClass {
public:
    java_lang_Boolean(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_BOOLEAN_H

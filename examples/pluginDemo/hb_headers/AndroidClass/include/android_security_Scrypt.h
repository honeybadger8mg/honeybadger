...
#ifndef HONEYBADGER_ANDROID_SECURITY_SCRYPT_H
#define HONEYBADGER_ANDROID_SECURITY_SCRYPT_H
...
class android_security_Scrypt : public ISimulateClass {
public:
    android_security_Scrypt(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_SECURITY_SCRYPT_H

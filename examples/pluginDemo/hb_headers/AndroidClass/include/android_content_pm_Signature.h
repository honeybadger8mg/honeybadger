...
#ifndef HONEYBADGER_ANDROID_CONTENT_PM_SIGNATURE_H
#define HONEYBADGER_ANDROID_CONTENT_PM_SIGNATURE_H
...
class android_content_pm_Signature : public ISimulateClass {
public:
    static android_content_pm_Signature *CreateNew(HB::EntryInterface *pDebugger, string strPkgName);
public:
    android_content_pm_Signature(HB::EntryInterface *pDebugger);
...
private:
    ...
    uint32_t m_signHashCodeValue;
    string m_strSignBuf; // 证书的字节流
};


#endif //HONEYBADGER_ANDROID_CONTENT_PM_SIGNATURE_H

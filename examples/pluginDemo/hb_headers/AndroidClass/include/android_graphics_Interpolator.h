...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_INTERPOLATOR_H
#define HONEYBADGER_ANDROID_GRAPHICS_INTERPOLATOR_H
...
class android_graphics_Interpolator : public ISimulateClass {
public:
    android_graphics_Interpolator(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_INTERPOLATOR_H

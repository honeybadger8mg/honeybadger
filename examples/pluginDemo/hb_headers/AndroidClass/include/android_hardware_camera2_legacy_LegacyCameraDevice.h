...
#ifndef HONEYBADGER_ANDROID_HARDWARE_CAMERA2_LEGACY_LEGACYCAMERADEVICE_H
#define HONEYBADGER_ANDROID_HARDWARE_CAMERA2_LEGACY_LEGACYCAMERADEVICE_H
...
class android_hardware_camera2_legacy_LegacyCameraDevice : public ISimulateClass {
public:
    android_hardware_camera2_legacy_LegacyCameraDevice(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_CAMERA2_LEGACY_LEGACYCAMERADEVICE_H

...
#ifndef HONEYBADGER_ANDROID_BACKUP_BACKUPDATAINPUT_H
#define HONEYBADGER_ANDROID_BACKUP_BACKUPDATAINPUT_H
...
class android_backup_BackupDataInput : public ISimulateClass {
public:
    android_backup_BackupDataInput(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_BACKUP_BACKUPDATAINPUT_H

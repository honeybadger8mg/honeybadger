...
#ifndef HONEYBADGER_ANDROID_UTIL_SPARSEINTARRAY_H
#define HONEYBADGER_ANDROID_UTIL_SPARSEINTARRAY_H
...
class android_util_SparseIntArray : public ISimulateClass {
public:
    android_util_SparseIntArray(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_UTIL_SPARSEINTARRAY_H

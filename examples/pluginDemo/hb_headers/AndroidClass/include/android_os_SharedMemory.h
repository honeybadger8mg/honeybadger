...
#ifndef HONEYBADGER_ANDROID_OS_SHAREDMEMORY_H
#define HONEYBADGER_ANDROID_OS_SHAREDMEMORY_H
...
class android_os_SharedMemory : public ISimulateClass {
public:
    android_os_SharedMemory(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_SHAREDMEMORY_H

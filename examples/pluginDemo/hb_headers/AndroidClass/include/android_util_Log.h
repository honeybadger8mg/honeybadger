...
#ifndef HONEYBADGER_ANDROID_UTIL_LOG_H
#define HONEYBADGER_ANDROID_UTIL_LOG_H
...
class android_util_Log : public ISimulateClass {
public:
    android_util_Log(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_UTIL_LOG_H

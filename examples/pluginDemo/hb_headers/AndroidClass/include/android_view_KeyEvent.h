...
#ifndef HONEYBADGER_ANDROID_VIEW_KEYEVENT_H
#define HONEYBADGER_ANDROID_VIEW_KEYEVENT_H
...
class android_view_KeyEvent : public ISimulateClass {
public:
    android_view_KeyEvent(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_KEYEVENT_H

...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_GLES11_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_GLES11_H
...
class android_opengl_jni_GLES11 : public ISimulateClass {
public:
    android_opengl_jni_GLES11(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_GLES11_H

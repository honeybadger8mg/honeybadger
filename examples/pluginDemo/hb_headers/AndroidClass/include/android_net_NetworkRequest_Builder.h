...
#ifndef HONEYBADGER_ANDROID_NET_NETWORKREQUEST_BUILDER_H
#define HONEYBADGER_ANDROID_NET_NETWORKREQUEST_BUILDER_H

#include "ISimulateClass.h"



class android_net_NetworkRequest_Builder  : public ISimulateClass {
public:
    android_net_NetworkRequest_Builder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_NET_NETWORKREQUEST_BUILDER_H

...
#ifndef HONEYBADGER_ANDROID_OS_LOCALELIST_H
#define HONEYBADGER_ANDROID_OS_LOCALELIST_H
...
class android_os_LocaleList : public ISimulateClass {
public:
    android_os_LocaleList(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_LOCALELIST_H

...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_CANVASPROPERTY_H
#define HONEYBADGER_ANDROID_GRAPHICS_CANVASPROPERTY_H
...
class android_graphics_CanvasProperty : public ISimulateClass {
public:
    android_graphics_CanvasProperty(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_CANVASPROPERTY_H

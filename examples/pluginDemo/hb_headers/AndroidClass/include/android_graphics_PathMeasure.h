...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_PATHMEASURE_H
#define HONEYBADGER_ANDROID_GRAPHICS_PATHMEASURE_H
...
class android_graphics_PathMeasure : public ISimulateClass {
public:
    android_graphics_PathMeasure(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_PATHMEASURE_H

...
#ifndef HONEYBADGER_OKHTTP3_CALL_H
#define HONEYBADGER_OKHTTP3_CALL_H

#include "ISimulateClass.h"



class okhttp3_Call : public ISimulateClass {
public:
    okhttp3_Call(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_CALL_H

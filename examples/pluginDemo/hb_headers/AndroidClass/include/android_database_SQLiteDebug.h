...
#ifndef HONEYBADGER_ANDROID_DATABASE_SQLITEDEBUG_H
#define HONEYBADGER_ANDROID_DATABASE_SQLITEDEBUG_H
...
class android_database_SQLiteDebug : public ISimulateClass {
public:
    android_database_SQLiteDebug(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_DATABASE_SQLITEDEBUG_H

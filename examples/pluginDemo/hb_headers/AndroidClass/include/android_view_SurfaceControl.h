...
#ifndef HONEYBADGER_ANDROID_VIEW_SURFACECONTROL_H
#define HONEYBADGER_ANDROID_VIEW_SURFACECONTROL_H
...
class android_view_SurfaceControl : public ISimulateClass {
public:
    android_view_SurfaceControl(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_SURFACECONTROL_H

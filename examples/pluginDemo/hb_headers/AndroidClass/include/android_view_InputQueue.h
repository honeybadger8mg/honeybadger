...
#ifndef HONEYBADGER_ANDROID_VIEW_INPUTQUEUE_H
#define HONEYBADGER_ANDROID_VIEW_INPUTQUEUE_H
...
class android_view_InputQueue : public ISimulateClass {
public:
    android_view_InputQueue(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_INPUTQUEUE_H

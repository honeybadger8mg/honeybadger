...
#ifndef HONEYBADGER_OKHTTP3_MEDIATYPE_H
#define HONEYBADGER_OKHTTP3_MEDIATYPE_H

#include "ISimulateClass.h"



class okhttp3_MediaType : public ISimulateClass {
public:
    okhttp3_MediaType(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_MEDIATYPE_H

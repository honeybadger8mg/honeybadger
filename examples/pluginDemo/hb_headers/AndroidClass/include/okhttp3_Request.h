...
#ifndef HONEYBADGER_OKHTTP3_REQUEST_H
#define HONEYBADGER_OKHTTP3_REQUEST_H
#include "ISimulateClass.h"



class okhttp3_Request: public ISimulateClass {
public:
    okhttp3_Request(HB::EntryInterface *pDebugger);

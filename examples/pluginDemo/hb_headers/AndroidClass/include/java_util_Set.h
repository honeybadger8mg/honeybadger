...
#ifndef HONEYBADGER_JAVA_UTIL_SET_H
#define HONEYBADGER_JAVA_UTIL_SET_H
...
class java_util_Set : public ISimulateClass {
public:
    java_util_Set(HB::EntryInterface *pDebugger);
...
private:
    ...
    /////
    std::vector<ISimulateClass *> m_vecDatas;
};



#endif //HONEYBADGER_JAVA_UTIL_SET_H

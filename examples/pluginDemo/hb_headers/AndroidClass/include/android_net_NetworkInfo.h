...
#ifndef HONEYBADGER_ANDROID_NET_NETWORKINFO_H
#define HONEYBADGER_ANDROID_NET_NETWORKINFO_H

#include "ISimulateClass.h"



class android_net_NetworkInfo : public ISimulateClass {
public:
    android_net_NetworkInfo(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_NET_NETWORKINFO_H

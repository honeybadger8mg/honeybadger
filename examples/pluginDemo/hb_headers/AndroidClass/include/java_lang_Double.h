...
#ifndef HONEYBADGER_JAVA_LANG_DOUBLE_H
#define HONEYBADGER_JAVA_LANG_DOUBLE_H

#include "ISimulateClass.h"



class java_lang_Double : public ISimulateClass {
public:
    java_lang_Double(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_DOUBLE_H

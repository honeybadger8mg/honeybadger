...
#ifndef HONEYBADGER_ANDROID_APP_KEYGUARDMANAGER_H
#define HONEYBADGER_ANDROID_APP_KEYGUARDMANAGER_H
...
class android_app_KeyguardManager : public ISimulateClass {
public:
    android_app_KeyguardManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_KEYGUARDMANAGER_H

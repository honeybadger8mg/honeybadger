...
#ifndef HONEYBADGER_OKHTTP3_OKHTTPCLIENT_H
#define HONEYBADGER_OKHTTP3_OKHTTPCLIENT_H

#include "ISimulateClass.h"



class okhttp3_OkHttpClient : public ISimulateClass {
public:
    okhttp3_OkHttpClient(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_OKHTTPCLIENT_H

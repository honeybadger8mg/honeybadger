...
#ifndef HONEYBADGER_ANDROID_VIEW_VELOCITYTRACKER_H
#define HONEYBADGER_ANDROID_VIEW_VELOCITYTRACKER_H
...
class android_view_VelocityTracker : public ISimulateClass {
public:
    android_view_VelocityTracker(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_VELOCITYTRACKER_H

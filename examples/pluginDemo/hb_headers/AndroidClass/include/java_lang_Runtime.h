...
#ifndef HONEYBADGER_JAVA_LANG_RUNTIME_H
#define HONEYBADGER_JAVA_LANG_RUNTIME_H
...
class java_lang_Runtime : public ISimulateClass {
public:
    java_lang_Runtime(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_RUNTIME_H

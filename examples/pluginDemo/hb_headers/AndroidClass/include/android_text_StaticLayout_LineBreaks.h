...
#ifndef HONEYBADGER_ANDROID_TEXT_STATICLAYOUT_LINEBREAKS_H
#define HONEYBADGER_ANDROID_TEXT_STATICLAYOUT_LINEBREAKS_H
...
class android_text_StaticLayout_LineBreaks : public ISimulateClass {
public:
    android_text_StaticLayout_LineBreaks(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_TEXT_STATICLAYOUT_LINEBREAKS_H

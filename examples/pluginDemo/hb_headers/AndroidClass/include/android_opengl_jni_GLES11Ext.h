...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_GLES11EXT_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_GLES11EXT_H
...
class android_opengl_jni_GLES11Ext : public ISimulateClass {
public:
    android_opengl_jni_GLES11Ext(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_GLES11EXT_H

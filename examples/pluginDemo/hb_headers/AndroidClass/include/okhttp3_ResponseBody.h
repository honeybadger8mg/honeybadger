...
#ifndef HONEYBADGER_OKHTTP3_RESPONSEBODY_H
#define HONEYBADGER_OKHTTP3_RESPONSEBODY_H

#include "ISimulateClass.h"


class okhttp3_ResponseBody : public ISimulateClass {
public:
    okhttp3_ResponseBody(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_RESPONSEBODY_H

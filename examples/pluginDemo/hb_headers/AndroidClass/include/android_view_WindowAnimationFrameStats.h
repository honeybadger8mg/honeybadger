...
#ifndef HONEYBADGER_ANDROID_VIEW_WINDOWANIMATIONFRAMESTATS_H
#define HONEYBADGER_ANDROID_VIEW_WINDOWANIMATIONFRAMESTATS_H
...
class android_view_WindowAnimationFrameStats : public ISimulateClass {
public:
    android_view_WindowAnimationFrameStats(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_WINDOWANIMATIONFRAMESTATS_H

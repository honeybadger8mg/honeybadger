...
#ifndef HONEYBADGER_JAVA_UTIL_HASHMAP_H
#define HONEYBADGER_JAVA_UTIL_HASHMAP_H
...
class java_util_HashMap : public ISimulateClass {
public:
    java_util_HashMap(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_UTIL_HASHMAP_H

...
#ifndef HONEYBADGER_OKHTTP3_OKHTTPCLIENT_BUILDER_H
#define HONEYBADGER_OKHTTP3_OKHTTPCLIENT_BUILDER_H

#include "ISimulateClass.h"



class okhttp3_OkHttpClient_Builder : public ISimulateClass {
public:
    okhttp3_OkHttpClient_Builder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_OKHTTPCLIENT_BUILDER_H

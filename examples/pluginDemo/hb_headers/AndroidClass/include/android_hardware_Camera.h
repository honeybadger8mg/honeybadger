...
#ifndef HONEYBADGER_ANDROID_HARDWARE_CAMERA_H
#define HONEYBADGER_ANDROID_HARDWARE_CAMERA_H
...
class android_hardware_Camera : public ISimulateClass {
public:
    android_hardware_Camera(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_CAMERA_H

...
#ifndef HONEYBADGER_ANDROID_MEDIA_TONEGENERATOR_H
#define HONEYBADGER_ANDROID_MEDIA_TONEGENERATOR_H
...
class android_media_ToneGenerator : public ISimulateClass {
public:
    android_media_ToneGenerator(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_MEDIA_TONEGENERATOR_H

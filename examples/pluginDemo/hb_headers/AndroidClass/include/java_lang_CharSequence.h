...
#ifndef HONEYBADGER_JAVA_LANG_CHARSEQUENCE_H
#define HONEYBADGER_JAVA_LANG_CHARSEQUENCE_H
...
class java_lang_CharSequence  : public ISimulateClass {
public:
    java_lang_CharSequence(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_CHARSEQUENCE_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_RENDERNODE_H
#define HONEYBADGER_ANDROID_VIEW_RENDERNODE_H
...
class android_view_RenderNode : public ISimulateClass {
public:
    android_view_RenderNode(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_RENDERNODE_H

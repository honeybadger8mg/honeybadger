...
#ifndef HONEYBADGER_VA_JINTARRAY_H
#define HONEYBADGER_VA_JINTARRAY_H
...
class VA_JIntArray : public ISimulateClass {
public:
    VA_JIntArray(HB::EntryInterface *pDebugger);
    ...
    uint32_t GetIntArrayElement(int iIndex);
    void AddNewValue(uint32_t iNewValue);
    void AddNewValue(uint32_t iNewValue, int iIndex);
...
public:
    static VA_JIntArray *CreateNew(HB::EntryInterface *pEntry, int iSize);
...
#endif //HONEYBADGER_VA_JINTARRAY_H

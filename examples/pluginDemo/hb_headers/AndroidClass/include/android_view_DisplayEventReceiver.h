...
#ifndef HONEYBADGER_ANDROID_VIEW_DISPLAYEVENTRECEIVER_H
#define HONEYBADGER_ANDROID_VIEW_DISPLAYEVENTRECEIVER_H
...
class android_view_DisplayEventReceiver : public ISimulateClass {
public:
    android_view_DisplayEventReceiver(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_DISPLAYEVENTRECEIVER_H

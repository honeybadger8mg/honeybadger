...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_YUVIMAGE_H
#define HONEYBADGER_ANDROID_GRAPHICS_YUVIMAGE_H
...
class android_graphics_YuvImage : public ISimulateClass {
public:
    android_graphics_YuvImage(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_YUVIMAGE_H

...
#ifndef HONEYBADGER_ANDROID_MEDIA_AUDIORECORD_H
#define HONEYBADGER_ANDROID_MEDIA_AUDIORECORD_H
...
class android_media_AudioRecord : public ISimulateClass {
public:
    android_media_AudioRecord(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_MEDIA_AUDIORECORD_H

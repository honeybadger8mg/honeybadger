...
#ifndef HONEYBADGER_ANDROID_APP_SERVICE_H
#define HONEYBADGER_ANDROID_APP_SERVICE_H

#include "ISimulateClass.h"



class android_app_Service : public ISimulateClass {
public:
    android_app_Service(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_SERVICE_H

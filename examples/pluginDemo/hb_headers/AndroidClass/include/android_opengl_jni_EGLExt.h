...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_EGLEXT_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_EGLEXT_H
...
class android_opengl_jni_EGLExt : public ISimulateClass {
public:
    android_opengl_jni_EGLExt(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_EGLEXT_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_FRAMEMETRICS_H
#define HONEYBADGER_ANDROID_VIEW_FRAMEMETRICS_H
...
class android_view_FrameMetrics : public ISimulateClass {
public:
    android_view_FrameMetrics(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_FRAMEMETRICS_H

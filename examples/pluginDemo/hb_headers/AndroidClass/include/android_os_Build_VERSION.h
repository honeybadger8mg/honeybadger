...
#ifndef HONEYBADGER_ANDROID_OS_BUILD_VERSION_H
#define HONEYBADGER_ANDROID_OS_BUILD_VERSION_H

#include "ISimulateClass.h"



class android_os_Build_VERSION : public ISimulateClass {
public:
    android_os_Build_VERSION(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_BUILD_VERSION_H

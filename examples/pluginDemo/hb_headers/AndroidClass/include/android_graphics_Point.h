...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_POINT_H
#define HONEYBADGER_ANDROID_GRAPHICS_POINT_H
...
class android_graphics_Point : public ISimulateClass {
public:
    android_graphics_Point(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_POINT_H

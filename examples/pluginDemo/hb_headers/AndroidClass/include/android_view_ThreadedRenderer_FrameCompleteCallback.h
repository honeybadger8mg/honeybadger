...
#ifndef HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_FRAMECOMPLETECALLBACK_H
#define HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_FRAMECOMPLETECALLBACK_H
...
class android_view_ThreadedRenderer_FrameCompleteCallback : public ISimulateClass {
public:
    android_view_ThreadedRenderer_FrameCompleteCallback(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_FRAMECOMPLETECALLBACK_H

...
#ifndef HONEYBADGER_ANDROID_APP_NATIVEACTIVITY_H
#define HONEYBADGER_ANDROID_APP_NATIVEACTIVITY_H
...
class android_app_NativeActivity : public ISimulateClass {
public:
    android_app_NativeActivity(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_NATIVEACTIVITY_H

...
#ifndef HONEYBADGER_JAVA_LANG_REFLECT_PROXY_H
#define HONEYBADGER_JAVA_LANG_REFLECT_PROXY_H
...
class java_lang_reflect_Proxy : public ISimulateClass {
public:
    java_lang_reflect_Proxy(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_REFLECT_PROXY_H

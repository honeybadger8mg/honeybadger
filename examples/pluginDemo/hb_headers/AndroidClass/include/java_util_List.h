...
#ifndef HONEYBADGER_JAVA_UTIL_LIST_H
#define HONEYBADGER_JAVA_UTIL_LIST_H

#include "ISimulateClass.h"
#include <vector>


class java_util_List : public ISimulateClass {
public:
    java_util_List(HB::EntryInterface *pDebugger);
...
public:
    void Add(ISimulateClass* pNewAdd);
...
private:
    ...
    vector<ISimulateClass *> m_listValue;

    HB::EntryInterface *m_pEntry;
};


#endif //HONEYBADGER_JAVA_UTIL_LIST_H

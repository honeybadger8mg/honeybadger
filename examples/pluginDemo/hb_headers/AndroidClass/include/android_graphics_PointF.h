...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_POINTF_H
#define HONEYBADGER_ANDROID_GRAPHICS_POINTF_H
...
class android_graphics_PointF : public ISimulateClass {
public:
    android_graphics_PointF(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_POINTF_H

...
#ifndef HONEYBADGER_JAVA_UTIL_DATE_H
#define HONEYBADGER_JAVA_UTIL_DATE_H

#include "ISimulateClass.h"



class java_util_Date : public ISimulateClass {
public:
    java_util_Date(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_UTIL_DATE_H

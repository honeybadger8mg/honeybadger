...
#ifndef HONEYBADGER_DALVIK_SYSTEM_VMRUNTIME_H
#define HONEYBADGER_DALVIK_SYSTEM_VMRUNTIME_H
...
class dalvik_system_VMRuntime : public ISimulateClass {
public:
    dalvik_system_VMRuntime(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_DALVIK_SYSTEM_VMRUNTIME_H

...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_PICTURE_H
#define HONEYBADGER_ANDROID_GRAPHICS_PICTURE_H
...
class android_graphics_Picture : public ISimulateClass {
public:
    android_graphics_Picture(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_PICTURE_H

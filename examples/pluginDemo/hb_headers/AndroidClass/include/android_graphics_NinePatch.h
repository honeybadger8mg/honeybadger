...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_NINEPATCH_H
#define HONEYBADGER_ANDROID_GRAPHICS_NINEPATCH_H
...
class android_graphics_NinePatch : public ISimulateClass {
public:
    android_graphics_NinePatch(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_NINEPATCH_H

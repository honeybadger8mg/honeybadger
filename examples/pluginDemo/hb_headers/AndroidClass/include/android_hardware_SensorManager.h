...
#ifndef HONEYBADGER_ANDROID_HARDWARE_SENSORMANAGER_H
#define HONEYBADGER_ANDROID_HARDWARE_SENSORMANAGER_H
...
class android_hardware_SensorManager : public ISimulateClass {
public:
    android_hardware_SensorManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_SENSORMANAGER_H

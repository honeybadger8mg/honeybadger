...
#ifndef HONEYBADGER_ANDROID_HARDWARE_USBDEVICECONNECTION_H
#define HONEYBADGER_ANDROID_HARDWARE_USBDEVICECONNECTION_H
...
class android_hardware_UsbDeviceConnection : public ISimulateClass {
public:
    android_hardware_UsbDeviceConnection(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_USBDEVICECONNECTION_H

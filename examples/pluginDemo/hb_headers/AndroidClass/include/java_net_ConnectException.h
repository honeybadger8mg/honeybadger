...
#ifndef HONEYBADGER_JAVA_NET_CONNECTEXCEPTION_H
#define HONEYBADGER_JAVA_NET_CONNECTEXCEPTION_H

#include "ISimulateClass.h"



class java_net_ConnectException : public ISimulateClass {
public:
    java_net_ConnectException(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_NET_CONNECTEXCEPTION_H

...
#ifndef HONEYBADGER_ANDROID_OS_HWREMOTEBINDER_H
#define HONEYBADGER_ANDROID_OS_HWREMOTEBINDER_H
...
class android_os_HwRemoteBinder : public ISimulateClass {
public:
    android_os_HwRemoteBinder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_HWREMOTEBINDER_H

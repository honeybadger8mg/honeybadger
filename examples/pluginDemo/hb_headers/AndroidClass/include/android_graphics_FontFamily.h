...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_FONTFAMILY_H
#define HONEYBADGER_ANDROID_GRAPHICS_FONTFAMILY_H
...
class android_graphics_FontFamily : public ISimulateClass {
public:
    android_graphics_FontFamily(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_FONTFAMILY_H

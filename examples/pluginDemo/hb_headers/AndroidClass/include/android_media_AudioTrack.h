...
#ifndef HONEYBADGER_ANDROID_MEDIA_AUDIOTRACK_H
#define HONEYBADGER_ANDROID_MEDIA_AUDIOTRACK_H
...
class android_media_AudioTrack : public ISimulateClass {
public:
    android_media_AudioTrack(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_MEDIA_AUDIOTRACK_H

...
#ifndef HONEYBADGER_ANDROID_HARDWARE_LOCATION_ACTIVITYRECOGNITIONHARDWARE_H
#define HONEYBADGER_ANDROID_HARDWARE_LOCATION_ACTIVITYRECOGNITIONHARDWARE_H
...
class android_hardware_location_ActivityRecognitionHardware : public ISimulateClass {
public:
    android_hardware_location_ActivityRecognitionHardware(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_LOCATION_ACTIVITYRECOGNITIONHARDWARE_H

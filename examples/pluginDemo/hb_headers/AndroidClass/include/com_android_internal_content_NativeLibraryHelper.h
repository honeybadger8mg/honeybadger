...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_CONTENT_NATIVELIBRARYHELPER_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_CONTENT_NATIVELIBRARYHELPER_H
...
class com_android_internal_content_NativeLibraryHelper : public ISimulateClass {
public:
    com_android_internal_content_NativeLibraryHelper(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_CONTENT_NATIVELIBRARYHELPER_H

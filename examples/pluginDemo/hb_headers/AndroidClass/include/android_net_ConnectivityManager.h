...
#ifndef HONEYBADGER_ANDROID_NET_CONNECTIVITYMANAGER_H
#define HONEYBADGER_ANDROID_NET_CONNECTIVITYMANAGER_H

#include "ISimulateClass.h"



class android_net_ConnectivityManager  : public ISimulateClass {
public:
    android_net_ConnectivityManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_NET_CONNECTIVITYMANAGER_H

...
#ifndef HONEYBADGER_ANDROID_CONTENT_SHAREDPREFERENCES_H
#define HONEYBADGER_ANDROID_CONTENT_SHAREDPREFERENCES_H

#include "ISimulateClass.h"



class android_content_SharedPreferences : public ISimulateClass {
public:
    android_content_SharedPreferences(HB::EntryInterface *pDebugger);
...
public: // 自有属性
    void SetSpFileName(string strSpName); // 自动创建路径
...
#endif //HONEYBADGER_ANDROID_CONTENT_SHAREDPREFERENCES_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_KEYCHARACTERMAP_FALLBACKACTION_H
#define HONEYBADGER_ANDROID_VIEW_KEYCHARACTERMAP_FALLBACKACTION_H
...
class android_view_KeyCharacterMap_FallbackAction : public ISimulateClass {
public:
    android_view_KeyCharacterMap_FallbackAction(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_KEYCHARACTERMAP_FALLBACKACTION_H

...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_RECT_H
#define HONEYBADGER_ANDROID_GRAPHICS_RECT_H
...
class android_graphics_Rect : public ISimulateClass {
public:
    android_graphics_Rect(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_RECT_H

...
#ifndef HONEYBADGER_ANDROID_MEDIA_REMOTEDISPLAY_H
#define HONEYBADGER_ANDROID_MEDIA_REMOTEDISPLAY_H
...
class android_media_RemoteDisplay : public ISimulateClass {
public:
    android_media_RemoteDisplay(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_MEDIA_REMOTEDISPLAY_H

...
#ifndef HONEYBADGER_OKHTTP3_REQUEST_BUILDER_H
#define HONEYBADGER_OKHTTP3_REQUEST_BUILDER_H
#include "ISimulateClass.h"




class okhttp3_Request_Builder : public ISimulateClass {
public:
    okhttp3_Request_Builder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_REQUEST_BUILDER_H

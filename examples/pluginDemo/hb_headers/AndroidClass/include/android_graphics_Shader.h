...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_SHADER_H
#define HONEYBADGER_ANDROID_GRAPHICS_SHADER_H
...
class android_graphics_Shader : public ISimulateClass {
public:
    android_graphics_Shader(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_SHADER_H

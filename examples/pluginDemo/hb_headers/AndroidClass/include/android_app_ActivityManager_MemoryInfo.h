...
#ifndef HONEYBADGER_ANDROID_APP_ACTIVITYMANAGER_MEMORYINFO_H
#define HONEYBADGER_ANDROID_APP_ACTIVITYMANAGER_MEMORYINFO_H

#include "ISimulateClass.h"



class android_app_ActivityManager_MemoryInfo : public ISimulateClass {
public:
    android_app_ActivityManager_MemoryInfo(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_ACTIVITYMANAGER_MEMORYINFO_H

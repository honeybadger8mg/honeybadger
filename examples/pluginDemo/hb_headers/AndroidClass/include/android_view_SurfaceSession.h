...
#ifndef HONEYBADGER_ANDROID_VIEW_SURFACESESSION_H
#define HONEYBADGER_ANDROID_VIEW_SURFACESESSION_H
...
class android_view_SurfaceSession : public ISimulateClass {
public:
    android_view_SurfaceSession(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_SURFACESESSION_H

...
#ifndef HONEYBADGER_ANDROID_UTIL_EVENTLOG_EVENT_H
#define HONEYBADGER_ANDROID_UTIL_EVENTLOG_EVENT_H
...
class android_util_EventLog_Event : public ISimulateClass {
public:
    android_util_EventLog_Event(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_UTIL_EVENTLOG_EVENT_H

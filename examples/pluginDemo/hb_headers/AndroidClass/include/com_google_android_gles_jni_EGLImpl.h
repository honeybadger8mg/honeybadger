...
#ifndef HONEYBADGER_COM_GOOGLE_ANDROID_GLES_JNI_EGLIMPL_H
#define HONEYBADGER_COM_GOOGLE_ANDROID_GLES_JNI_EGLIMPL_H
...
class com_google_android_gles_jni_EGLImpl : public ISimulateClass {
public:
    com_google_android_gles_jni_EGLImpl(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_GOOGLE_ANDROID_GLES_JNI_EGLIMPL_H

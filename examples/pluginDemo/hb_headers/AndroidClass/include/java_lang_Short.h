...
#ifndef HONEYBADGER_JAVA_LANG_SHORT_H
#define HONEYBADGER_JAVA_LANG_SHORT_H

#include "ISimulateClass.h"



class java_lang_Short : public ISimulateClass {
public:
    java_lang_Short(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_SHORT_H

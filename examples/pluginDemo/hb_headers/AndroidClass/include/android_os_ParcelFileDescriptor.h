...
#ifndef HONEYBADGER_ANDROID_OS_PARCELFILEDESCRIPTOR_H
#define HONEYBADGER_ANDROID_OS_PARCELFILEDESCRIPTOR_H
...
class android_os_ParcelFileDescriptor : public ISimulateClass {
public:
    android_os_ParcelFileDescriptor(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_PARCELFILEDESCRIPTOR_H

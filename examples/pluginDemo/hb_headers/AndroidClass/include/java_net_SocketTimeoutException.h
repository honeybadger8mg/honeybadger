...
#ifndef HONEYBADGER_JAVA_NET_SOCKETTIMEOUTEXCEPTION_H
#define HONEYBADGER_JAVA_NET_SOCKETTIMEOUTEXCEPTION_H

#include "ISimulateClass.h"



class java_net_SocketTimeoutException : public ISimulateClass {
public:
    java_net_SocketTimeoutException(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_NET_SOCKETTIMEOUTEXCEPTION_H

...
#ifndef HONEYBADGER_ANDROID_CONTENT_RES_RESOURCES_H
#define HONEYBADGER_ANDROID_CONTENT_RES_RESOURCES_H

#include "ISimulateClass.h"



class android_content_res_Resources : public ISimulateClass {
public:
    android_content_res_Resources(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_CONTENT_RES_RESOURCES_H

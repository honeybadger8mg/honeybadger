...
#ifndef HONEYBADGER_ANDROID_OS_SYSTEMPROPERTIES_H
#define HONEYBADGER_ANDROID_OS_SYSTEMPROPERTIES_H

#include "ISimulateClass.h"



class android_os_SystemProperties : public ISimulateClass {
public:
    android_os_SystemProperties(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_SYSTEMPROPERTIES_H

...
#ifndef HONEYBADGER_ANDROID_NET_LOCALSOCKETIMPL_H
#define HONEYBADGER_ANDROID_NET_LOCALSOCKETIMPL_H
...
class android_net_LocalSocketImpl : public ISimulateClass {
public:
    android_net_LocalSocketImpl(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_NET_LOCALSOCKETIMPL_H

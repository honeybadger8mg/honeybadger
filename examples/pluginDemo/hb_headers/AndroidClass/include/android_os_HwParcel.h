...
#ifndef HONEYBADGER_ANDROID_OS_HWPARCEL_H
#define HONEYBADGER_ANDROID_OS_HWPARCEL_H
...
class android_os_HwParcel : public ISimulateClass {
public:
    android_os_HwParcel(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_HWPARCEL_H

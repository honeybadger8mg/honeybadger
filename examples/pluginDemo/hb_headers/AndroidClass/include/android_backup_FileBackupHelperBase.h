...
#ifndef HONEYBADGER_ANDROID_BACKUP_FILEBACKUPHELPERBASE_H
#define HONEYBADGER_ANDROID_BACKUP_FILEBACKUPHELPERBASE_H
...
class android_backup_FileBackupHelperBase : public ISimulateClass {
public:
    android_backup_FileBackupHelperBase(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_BACKUP_FILEBACKUPHELPERBASE_H

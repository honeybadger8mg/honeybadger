...
#ifndef HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_H
#define HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_H
...
class android_view_ThreadedRenderer : public ISimulateClass {
public:
    android_view_ThreadedRenderer(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_THREADEDRENDERER_H

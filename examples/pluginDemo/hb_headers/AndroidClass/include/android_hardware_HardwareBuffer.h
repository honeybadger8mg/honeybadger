...
#ifndef HONEYBADGER_ANDROID_HARDWARE_HARDWAREBUFFER_H
#define HONEYBADGER_ANDROID_HARDWARE_HARDWAREBUFFER_H
...
class android_hardware_HardwareBuffer : public ISimulateClass {
public:
    android_hardware_HardwareBuffer(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_HARDWAREBUFFER_H

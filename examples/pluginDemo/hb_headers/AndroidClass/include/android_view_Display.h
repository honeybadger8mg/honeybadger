...
#ifndef HONEYBADGER_ANDROID_VIEW_DISPLAY_H
#define HONEYBADGER_ANDROID_VIEW_DISPLAY_H

#include "ISimulateClass.h"



class android_view_Display : public ISimulateClass {
public:
    android_view_Display(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_DISPLAY_H

...
#ifndef HONEYBADGER_ANDROID_OS_MESSAGEQUEUE_H
#define HONEYBADGER_ANDROID_OS_MESSAGEQUEUE_H
...
class android_os_MessageQueue : public ISimulateClass {
public:
    android_os_MessageQueue(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_MESSAGEQUEUE_H

...
#ifndef HONEYBADGER_OKHTTP3_MULTIPARTBODY_H
#define HONEYBADGER_OKHTTP3_MULTIPARTBODY_H

#include "ISimulateClass.h"



class okhttp3_MultipartBody : public ISimulateClass {
public:
    okhttp3_MultipartBody(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_MULTIPARTBODY_H

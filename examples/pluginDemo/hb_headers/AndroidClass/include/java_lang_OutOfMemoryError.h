...
#ifndef HONEYBADGER_JAVA_LANG_OUTOFMEMORYERROR_H
#define HONEYBADGER_JAVA_LANG_OUTOFMEMORYERROR_H
...
class java_lang_OutOfMemoryError : public ISimulateClass {
public:
    java_lang_OutOfMemoryError(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_OUTOFMEMORYERROR_H

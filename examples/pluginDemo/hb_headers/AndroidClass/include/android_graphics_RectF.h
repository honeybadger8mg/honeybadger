...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_RECTF_H
#define HONEYBADGER_ANDROID_GRAPHICS_RECTF_H
...
class android_graphics_RectF : public ISimulateClass {
public:
    android_graphics_RectF(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_RECTF_H

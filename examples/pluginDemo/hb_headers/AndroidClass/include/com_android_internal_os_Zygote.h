...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_OS_ZYGOTE_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_OS_ZYGOTE_H
...
class com_android_internal_os_Zygote : public ISimulateClass {
public:
    com_android_internal_os_Zygote(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_OS_ZYGOTE_H

...
#ifndef HONEYBADGER_ANDROID_HARDWARE_USBREQUEST_H
#define HONEYBADGER_ANDROID_HARDWARE_USBREQUEST_H
...
class android_hardware_UsbRequest : public ISimulateClass {
public:
    android_hardware_UsbRequest(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_USBREQUEST_H

...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_OS_ZYGOTEINIT_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_OS_ZYGOTEINIT_H
...
class com_android_internal_os_ZygoteInit : public ISimulateClass {
public:
    com_android_internal_os_ZygoteInit(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_OS_ZYGOTEINIT_H

...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_GLES10EXT_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_GLES10EXT_H
...
class android_opengl_jni_GLES10Ext : public ISimulateClass {
public:
    android_opengl_jni_GLES10Ext(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_GLES10EXT_H

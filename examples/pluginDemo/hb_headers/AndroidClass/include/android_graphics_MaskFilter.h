...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_MASKFILTER_H
#define HONEYBADGER_ANDROID_GRAPHICS_MASKFILTER_H
...
class android_graphics_MaskFilter : public ISimulateClass {
public:
    android_graphics_MaskFilter(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_MASKFILTER_H

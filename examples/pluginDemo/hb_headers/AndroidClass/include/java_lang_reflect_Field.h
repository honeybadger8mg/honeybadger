...
#ifndef HONEYBADGER_JAVA_LANG_REFLECT_FIELD_H
#define HONEYBADGER_JAVA_LANG_REFLECT_FIELD_H

#include "ISimulateClass.h"



class java_lang_reflect_Field : public ISimulateClass {
public:
    java_lang_reflect_Field(HB::EntryInterface *pDebugger);
...
public:
    void SetFieldInfo(ISimulateClass *pOwner, string strFieldName);
...
#endif //HONEYBADGER_JAVA_LANG_REFLECT_FIELD_H

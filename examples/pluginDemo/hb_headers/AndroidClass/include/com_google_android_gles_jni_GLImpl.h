...
#ifndef HONEYBADGER_COM_GOOGLE_ANDROID_GLES_JNI_GLIMPL_H
#define HONEYBADGER_COM_GOOGLE_ANDROID_GLES_JNI_GLIMPL_H
...
class com_google_android_gles_jni_GLImpl : public ISimulateClass {
public:
    com_google_android_gles_jni_GLImpl(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_GOOGLE_ANDROID_GLES_JNI_GLIMPL_H

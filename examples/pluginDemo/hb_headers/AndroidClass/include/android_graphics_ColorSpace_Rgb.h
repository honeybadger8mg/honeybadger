...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_RGB_H
#define HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_RGB_H
...
class android_graphics_ColorSpace_Rgb : public ISimulateClass {
public:
    android_graphics_ColorSpace_Rgb(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_RGB_H

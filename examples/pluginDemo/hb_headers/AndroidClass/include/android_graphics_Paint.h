...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_PAINT_H
#define HONEYBADGER_ANDROID_GRAPHICS_PAINT_H
...
class android_graphics_Paint : public ISimulateClass {
public:
    android_graphics_Paint(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_PAINT_H

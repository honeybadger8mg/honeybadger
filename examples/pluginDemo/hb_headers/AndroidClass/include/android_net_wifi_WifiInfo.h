...
#ifndef HONEYBADGER_ANDROID_NET_WIFI_WIFIINFO_H
#define HONEYBADGER_ANDROID_NET_WIFI_WIFIINFO_H

#include "ISimulateClass.h"



class android_net_wifi_WifiInfo : public ISimulateClass {
public:
    android_net_wifi_WifiInfo(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_NET_WIFI_WIFIINFO_H

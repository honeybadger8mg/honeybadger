...
#ifndef HONEYBADGER_ANDROID_TELEPHONY_TELEPHONYMANAGER_H
#define HONEYBADGER_ANDROID_TELEPHONY_TELEPHONYMANAGER_H

#include "ISimulateClass.h"



class android_telephony_TelephonyManager : public ISimulateClass {
public:
    android_telephony_TelephonyManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_TELEPHONY_TELEPHONYMANAGER_H

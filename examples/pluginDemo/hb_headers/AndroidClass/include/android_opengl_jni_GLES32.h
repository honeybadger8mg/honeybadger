...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_GLES32_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_GLES32_H
...
class android_opengl_jni_GLES32 : public ISimulateClass {
public:
    android_opengl_jni_GLES32(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_GLES32_H

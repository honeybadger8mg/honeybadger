...
#ifndef HONEYBADGER_ANDROID_NET_NETWORKUTILS_H
#define HONEYBADGER_ANDROID_NET_NETWORKUTILS_H
...
class android_net_NetworkUtils : public ISimulateClass {
public:
    android_net_NetworkUtils(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_NET_NETWORKUTILS_H

...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_BITMAP_H
#define HONEYBADGER_ANDROID_GRAPHICS_BITMAP_H
...
class android_graphics_Bitmap : public ISimulateClass {
public:
    android_graphics_Bitmap(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_BITMAP_H

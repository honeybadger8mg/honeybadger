...
#ifndef HONEYBADGER_JAVA_UTIL_ITERATOR_H
#define HONEYBADGER_JAVA_UTIL_ITERATOR_H
...
class java_util_Iterator : public ISimulateClass {
public:
    java_util_Iterator(HB::EntryInterface *pDebugger);
...
private:
    ...
    vector<ISimulateClass *> m_vecDatas;
    int m_iEnumIndex;
};



#endif //HONEYBADGER_JAVA_UTIL_ITERATOR_H

...
#ifndef HONEYBADGER_ANDROIDX_CORE_CONTENT_CONTEXTCOMPAT_H
#define HONEYBADGER_ANDROIDX_CORE_CONTENT_CONTEXTCOMPAT_H

#include "ISimulateClass.h"



class androidx_core_content_ContextCompat : public ISimulateClass {
public:
    androidx_core_content_ContextCompat(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROIDX_CORE_CONTENT_CONTEXTCOMPAT_H

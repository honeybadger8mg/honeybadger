...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_CREATEJAVAOUTPUTSTREAMADAPTOR_H
#define HONEYBADGER_ANDROID_GRAPHICS_CREATEJAVAOUTPUTSTREAMADAPTOR_H
...
class android_graphics_CreateJavaOutputStreamAdaptor : public ISimulateClass {
public:
    android_graphics_CreateJavaOutputStreamAdaptor(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_CREATEJAVAOUTPUTSTREAMADAPTOR_H

...
#ifndef HONEYBADGER_ANDROID_HARDWARE_CAMERA2_CAMERAMETADATA_H
#define HONEYBADGER_ANDROID_HARDWARE_CAMERA2_CAMERAMETADATA_H
...
class android_hardware_camera2_CameraMetadata : public ISimulateClass {
public:
    android_hardware_camera2_CameraMetadata(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_CAMERA2_CAMERAMETADATA_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_TEXTURELAYER_H
#define HONEYBADGER_ANDROID_VIEW_TEXTURELAYER_H
...
class android_view_TextureLayer : public ISimulateClass {
public:
    android_view_TextureLayer(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_TEXTURELAYER_H

...
#ifndef HONEYBADGER_JAVA_LANG_THREAD_H
#define HONEYBADGER_JAVA_LANG_THREAD_H

#include "ISimulateClass.h"



class java_lang_Thread  : public ISimulateClass {
public:
    java_lang_Thread(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_THREAD_H

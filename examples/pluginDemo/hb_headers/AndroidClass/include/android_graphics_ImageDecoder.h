...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_IMAGEDECODER_H
#define HONEYBADGER_ANDROID_GRAPHICS_IMAGEDECODER_H
...
class android_graphics_ImageDecoder : public ISimulateClass {
public:
    android_graphics_ImageDecoder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_IMAGEDECODER_H

...
#ifndef HONEYBADGER_JAVA_LANG_CLASSLOADER_H
#define HONEYBADGER_JAVA_LANG_CLASSLOADER_H

#include "ISimulateClass.h"



class java_lang_ClassLoader : public ISimulateClass {
public:
    java_lang_ClassLoader(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_CLASSLOADER_H

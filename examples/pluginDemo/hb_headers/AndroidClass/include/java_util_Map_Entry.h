...
#ifndef HONEYBADGER_JAVA_UTIL_MAP_ENTRY_H
#define HONEYBADGER_JAVA_UTIL_MAP_ENTRY_H

#include "ISimulateClass.h"



class java_util_Map_Entry : public ISimulateClass {
public:
    java_util_Map_Entry(HB::EntryInterface *pDebugger);
...
public:
    void SetValuePair(ISimulateClass *pDataKey, ISimulateClass *pDataValue);
...
private:
    ...
    ////////
    ISimulateClass *m_pDataKey;
    ISimulateClass *m_pDataValue;
};



#endif //HONEYBADGER_JAVA_UTIL_MAP_ENTRY_H

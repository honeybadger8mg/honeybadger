...
#ifndef HONEYBADGER_ANDROID_APP_ACTIVITY_H
#define HONEYBADGER_ANDROID_APP_ACTIVITY_H

#include <EntryInterface.h>
#include "ISimulateClass.h"

class android_app_Activity : public ISimulateClass {
public:
    android_app_Activity(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_ACTIVITY_H

...
#ifndef HONEYBADGER_ANDROID_OS_PARCEL_H
#define HONEYBADGER_ANDROID_OS_PARCEL_H
...
class android_os_Parcel : public ISimulateClass {
public:
    android_os_Parcel(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_PARCEL_H

...
#ifndef HONEYBADGER_ANDROID_OS_BINDER_H
#define HONEYBADGER_ANDROID_OS_BINDER_H
...
class android_os_Binder : public ISimulateClass {
public:
    android_os_Binder(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_BINDER_H

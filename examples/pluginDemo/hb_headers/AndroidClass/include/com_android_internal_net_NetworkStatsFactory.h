...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_NET_NETWORKSTATSFACTORY_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_NET_NETWORKSTATSFACTORY_H
...
class com_android_internal_net_NetworkStatsFactory : public ISimulateClass {
public:
    com_android_internal_net_NetworkStatsFactory(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_NET_NETWORKSTATSFACTORY_H

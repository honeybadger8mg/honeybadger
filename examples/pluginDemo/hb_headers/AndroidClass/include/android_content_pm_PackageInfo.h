...
#ifndef HONEYBADGER_ANDROID_CONTENT_PM_PACKAGEINFO_H
#define HONEYBADGER_ANDROID_CONTENT_PM_PACKAGEINFO_H

#include "ISimulateClass.h"
#include "Array_android_content_pm_Signature.h"



class android_content_pm_PackageInfo : public ISimulateClass {
public:
    static android_content_pm_PackageInfo* CreateNew(HB::EntryInterface *pDebugger, string strPkgName);
public:
    android_content_pm_PackageInfo(HB::EntryInterface *pDebugger);
...
private:
    ...
    string m_strPkgName;
    Array_android_content_pm_Signature *m_Signature;
};


#endif //HONEYBADGER_ANDROID_CONTENT_PM_PACKAGEINFO_H

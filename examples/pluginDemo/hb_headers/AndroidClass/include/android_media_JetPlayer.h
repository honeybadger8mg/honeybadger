...
#ifndef HONEYBADGER_ANDROID_MEDIA_JETPLAYER_H
#define HONEYBADGER_ANDROID_MEDIA_JETPLAYER_H
...
class android_media_JetPlayer : public ISimulateClass {
public:
    android_media_JetPlayer(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_MEDIA_JETPLAYER_H

...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_TYPEFACE_H
#define HONEYBADGER_ANDROID_GRAPHICS_TYPEFACE_H
...
class android_graphics_Typeface : public ISimulateClass {
public:
    android_graphics_Typeface(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_TYPEFACE_H

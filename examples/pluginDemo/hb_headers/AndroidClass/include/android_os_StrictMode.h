...
#ifndef HONEYBADGER_ANDROID_OS_STRICTMODE_H
#define HONEYBADGER_ANDROID_OS_STRICTMODE_H
...
class android_os_StrictMode : public ISimulateClass {
public:
    android_os_StrictMode(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_STRICTMODE_H

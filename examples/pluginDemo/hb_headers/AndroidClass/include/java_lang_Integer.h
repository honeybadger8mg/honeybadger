...
#ifndef HONEYBADGER_JAVA_LANG_INTEGER_H
#define HONEYBADGER_JAVA_LANG_INTEGER_H

#include "ISimulateClass.h"



class java_lang_Integer : public ISimulateClass {
public:
    java_lang_Integer(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_INTEGER_H

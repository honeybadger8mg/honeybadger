...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFRENDERER_H
#define HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFRENDERER_H
...
class android_graphics_pdf_PdfRenderer : public ISimulateClass {
public:
    android_graphics_pdf_PdfRenderer(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFRENDERER_H

...
#ifndef HONEYBADGER_ANDROID_UTIL_SPARSEARRAY_H
#define HONEYBADGER_ANDROID_UTIL_SPARSEARRAY_H
...
class android_util_SparseArray : public ISimulateClass {
public:
    android_util_SparseArray(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_UTIL_SPARSEARRAY_H

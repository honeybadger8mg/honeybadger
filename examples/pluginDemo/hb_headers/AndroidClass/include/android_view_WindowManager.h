...
#ifndef HONEYBADGER_ANDROID_VIEW_WINDOWMANAGER_H
#define HONEYBADGER_ANDROID_VIEW_WINDOWMANAGER_H

#include "ISimulateClass.h"



class android_view_WindowManager : public ISimulateClass {
public:
    android_view_WindowManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_WINDOWMANAGER_H

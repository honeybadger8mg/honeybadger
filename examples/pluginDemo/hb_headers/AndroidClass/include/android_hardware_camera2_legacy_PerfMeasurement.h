...
#ifndef HONEYBADGER_ANDROID_HARDWARE_CAMERA2_LEGACY_PERFMEASUREMENT_H
#define HONEYBADGER_ANDROID_HARDWARE_CAMERA2_LEGACY_PERFMEASUREMENT_H
...
class android_hardware_camera2_legacy_PerfMeasurement : public ISimulateClass {
public:
    android_hardware_camera2_legacy_PerfMeasurement(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_CAMERA2_LEGACY_PERFMEASUREMENT_H

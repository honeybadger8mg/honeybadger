...
#ifndef HONEYBADGER_ANDROID_BACKUP_BACKUPHELPERDISPATCHER_H
#define HONEYBADGER_ANDROID_BACKUP_BACKUPHELPERDISPATCHER_H
...
class android_backup_BackupHelperDispatcher : public ISimulateClass {
public:
    android_backup_BackupHelperDispatcher(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_BACKUP_BACKUPHELPERDISPATCHER_H

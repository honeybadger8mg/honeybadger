...
#ifndef HONEYBADGER_ANDROID_CONTENT_RES_ASSETFILEDESCRIPTOR_H
#define HONEYBADGER_ANDROID_CONTENT_RES_ASSETFILEDESCRIPTOR_H
...
class android_content_res_AssetFileDescriptor : public ISimulateClass {
public:
    android_content_res_AssetFileDescriptor(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_CONTENT_RES_ASSETFILEDESCRIPTOR_H

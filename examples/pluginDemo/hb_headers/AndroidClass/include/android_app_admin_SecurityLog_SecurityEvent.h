...
#ifndef HONEYBADGER_ANDROID_APP_ADMIN_SECURITYLOG_SECURITYEVENT_H
#define HONEYBADGER_ANDROID_APP_ADMIN_SECURITYLOG_SECURITYEVENT_H
...
class android_app_admin_SecurityLog_SecurityEvent : public ISimulateClass {
public:
    android_app_admin_SecurityLog_SecurityEvent(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_ADMIN_SECURITYLOG_SECURITYEVENT_H

...
#ifndef HONEYBADGER_ANDROID_OS_SELINUX_H
#define HONEYBADGER_ANDROID_OS_SELINUX_H
...
class android_os_SELinux : public ISimulateClass {
public:
    android_os_SELinux(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_SELINUX_H

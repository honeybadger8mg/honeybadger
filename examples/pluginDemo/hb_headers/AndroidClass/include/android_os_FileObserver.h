...
#ifndef HONEYBADGER_ANDROID_OS_FILEOBSERVER_H
#define HONEYBADGER_ANDROID_OS_FILEOBSERVER_H
...
class android_os_FileObserver : public ISimulateClass {
public:
    android_os_FileObserver(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_FILEOBSERVER_H

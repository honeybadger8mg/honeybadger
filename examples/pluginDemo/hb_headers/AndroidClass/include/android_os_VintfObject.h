...
#ifndef HONEYBADGER_ANDROID_OS_VINTFOBJECT_H
#define HONEYBADGER_ANDROID_OS_VINTFOBJECT_H
...
class android_os_VintfObject : public ISimulateClass {
public:
    android_os_VintfObject(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_VINTFOBJECT_H

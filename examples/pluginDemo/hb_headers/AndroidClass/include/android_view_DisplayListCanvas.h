...
#ifndef HONEYBADGER_ANDROID_VIEW_DISPLAYLISTCANVAS_H
#define HONEYBADGER_ANDROID_VIEW_DISPLAYLISTCANVAS_H
...
class android_view_DisplayListCanvas : public ISimulateClass {
public:
    android_view_DisplayListCanvas(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_DISPLAYLISTCANVAS_H

...
#ifndef HONEYBADGER_JAVA_LANG_STRING_H
#define HONEYBADGER_JAVA_LANG_STRING_H

#include "ISimulateClass.h"



class java_lang_String : public ISimulateClass {
public:
    java_lang_String(HB::EntryInterface *pDebugger);
    static java_lang_String *CreateNew(HB::EntryInterface *pEntry);
    static java_lang_String *CreateNew(HB::EntryInterface *pEntry, string strContent);
...
public:
    java_lang_String * SetContent(string strContent);
    string GetContent();
...
#endif //HONEYBADGER_JAVA_LANG_STRING_H

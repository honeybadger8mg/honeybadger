...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_H
#define HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_H
...
class android_graphics_ColorSpace : public ISimulateClass {
public:
    android_graphics_ColorSpace(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_COLORSPACE_H

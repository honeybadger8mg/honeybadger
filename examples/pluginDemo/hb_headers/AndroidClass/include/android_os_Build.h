...
#ifndef HONEYBADGER_ANDROID_OS_BUILD_H
#define HONEYBADGER_ANDROID_OS_BUILD_H

#include "ISimulateClass.h"



class android_os_Build : public ISimulateClass {
public:
    android_os_Build(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_BUILD_H

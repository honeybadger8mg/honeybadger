...
#ifndef HONEYBADGER_JAVA_LANG_OBJECT_H
#define HONEYBADGER_JAVA_LANG_OBJECT_H

#include "ISimulateClass.h"



class java_lang_Object : public ISimulateClass {
public:
    java_lang_Object(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_OBJECT_H

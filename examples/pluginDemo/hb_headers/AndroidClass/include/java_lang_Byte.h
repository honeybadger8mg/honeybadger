...
#ifndef HONEYBADGER_JAVA_LANG_BYTE_H
#define HONEYBADGER_JAVA_LANG_BYTE_H

#include "ISimulateClass.h"



class java_lang_Byte : public ISimulateClass {
public:
    java_lang_Byte(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_BYTE_H

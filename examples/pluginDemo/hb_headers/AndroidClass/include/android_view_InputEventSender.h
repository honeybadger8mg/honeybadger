...
#ifndef HONEYBADGER_ANDROID_VIEW_INPUTEVENTSENDER_H
#define HONEYBADGER_ANDROID_VIEW_INPUTEVENTSENDER_H
...
class android_view_InputEventSender : public ISimulateClass {
public:
    android_view_InputEventSender(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_INPUTEVENTSENDER_H

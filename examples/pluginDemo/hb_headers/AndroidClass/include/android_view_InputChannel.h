...
#ifndef HONEYBADGER_ANDROID_VIEW_INPUTCHANNEL_H
#define HONEYBADGER_ANDROID_VIEW_INPUTCHANNEL_H
...
class android_view_InputChannel : public ISimulateClass {
public:
    android_view_InputChannel(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_INPUTCHANNEL_H

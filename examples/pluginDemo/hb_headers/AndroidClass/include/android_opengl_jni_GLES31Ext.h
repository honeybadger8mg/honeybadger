...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_GLES31EXT_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_GLES31EXT_H
...
class android_opengl_jni_GLES31Ext : public ISimulateClass {
public:
    android_opengl_jni_GLES31Ext(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_GLES31EXT_H

...
#ifndef HONEYBADGER_ANDROID_CONTENT_RES_CONFIGURATION_H
#define HONEYBADGER_ANDROID_CONTENT_RES_CONFIGURATION_H

#include "ISimulateClass.h"



class android_content_res_Configuration : public ISimulateClass {
public:
    android_content_res_Configuration(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_CONTENT_RES_CONFIGURATION_H

...
#ifndef HONEYBADGER_JAVA_IO_IOEXCEPTION_H
#define HONEYBADGER_JAVA_IO_IOEXCEPTION_H
...
class java_io_IOException : public ISimulateClass {
public:
    java_io_IOException(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_IO_IOEXCEPTION_H

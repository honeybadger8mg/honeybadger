...
#ifndef HONEYBADGER_OKIO_BUFFER_H
#define HONEYBADGER_OKIO_BUFFER_H
#include "ISimulateClass.h"



class okio_Buffer : public ISimulateClass {
public:
    okio_Buffer(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKIO_BUFFER_H

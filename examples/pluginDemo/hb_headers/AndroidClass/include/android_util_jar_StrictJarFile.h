...
#ifndef HONEYBADGER_ANDROID_UTIL_JAR_STRICTJARFILE_H
#define HONEYBADGER_ANDROID_UTIL_JAR_STRICTJARFILE_H
...
class android_util_jar_StrictJarFile : public ISimulateClass {
public:
    android_util_jar_StrictJarFile(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_UTIL_JAR_STRICTJARFILE_H

...
#ifndef HONEYBADGER_JAVA_LANG_CLASS_H
#define HONEYBADGER_JAVA_LANG_CLASS_H

#include "ISimulateClass.h"



class java_lang_Class : public ISimulateClass {
public:
    java_lang_Class(HB::EntryInterface *pDebugger);
...
public:
    void SetFromClassInfo(string strFromClsSig);
    ...
    string m_strFromClassSig; // xxx.getClass() 的xxx类签名
...
#endif //HONEYBADGER_JAVA_LANG_CLASS_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_DISPLAY_HDRCAPABILITIES_H
#define HONEYBADGER_ANDROID_VIEW_DISPLAY_HDRCAPABILITIES_H
...
class android_view_Display_HdrCapabilities : public ISimulateClass {
public:
    android_view_Display_HdrCapabilities(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_DISPLAY_HDRCAPABILITIES_H

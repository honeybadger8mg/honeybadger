...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_COLORFILTER_H
#define HONEYBADGER_ANDROID_GRAPHICS_COLORFILTER_H
...
class android_graphics_ColorFilter : public ISimulateClass {
public:
    android_graphics_ColorFilter(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_COLORFILTER_H

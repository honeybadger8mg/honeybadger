...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFEDITOR_H
#define HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFEDITOR_H
...
class android_graphics_pdf_PdfEditor : public ISimulateClass {
public:
    android_graphics_pdf_PdfEditor(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_PDF_PDFEDITOR_H

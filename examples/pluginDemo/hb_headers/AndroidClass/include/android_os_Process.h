...
#ifndef HONEYBADGER_ANDROID_OS_PROCESS_H
#define HONEYBADGER_ANDROID_OS_PROCESS_H
...
class android_os_Process : public ISimulateClass {
public:
    android_os_Process(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_PROCESS_H

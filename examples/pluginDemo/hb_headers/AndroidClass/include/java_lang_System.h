//
// Created by ice on 2020/5/24.
//

#ifndef HONEYBADGER_JAVA_LANG_SYSTEM_H
#define HONEYBADGER_JAVA_LANG_SYSTEM_H

#include "ISimulateClass.h"



class java_lang_System : public ISimulateClass {
public:
    java_lang_System(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_SYSTEM_H

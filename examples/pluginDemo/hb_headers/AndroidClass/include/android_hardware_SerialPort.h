...
#ifndef HONEYBADGER_ANDROID_HARDWARE_SERIALPORT_H
#define HONEYBADGER_ANDROID_HARDWARE_SERIALPORT_H
...
class android_hardware_SerialPort : public ISimulateClass {
public:
    android_hardware_SerialPort(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_HARDWARE_SERIALPORT_H

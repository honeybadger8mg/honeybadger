...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_BITMAPFACTORY_H
#define HONEYBADGER_ANDROID_GRAPHICS_BITMAPFACTORY_H
...
class android_graphics_BitmapFactory : public ISimulateClass {
public:
    android_graphics_BitmapFactory(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_BITMAPFACTORY_H

...
#ifndef HONEYBADGER_JAVA_IO_BYTEARRAYINPUTSTREAM_H
#define HONEYBADGER_JAVA_IO_BYTEARRAYINPUTSTREAM_H
...
class java_io_ByteArrayInputStream : public ISimulateClass {
public:
    java_io_ByteArrayInputStream(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_IO_BYTEARRAYINPUTSTREAM_H

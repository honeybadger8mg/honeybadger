...
#ifndef HONEYBADGER_ANDROID_CONTENT_RES_OBBSCANNER_H
#define HONEYBADGER_ANDROID_CONTENT_RES_OBBSCANNER_H
...
class android_content_res_ObbScanner : public ISimulateClass {
public:
    android_content_res_ObbScanner(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_CONTENT_RES_OBBSCANNER_H

...
#ifndef HONEYBADGER_ANDROID_VIEW_FRAMESTATS_H
#define HONEYBADGER_ANDROID_VIEW_FRAMESTATS_H
...
class android_view_FrameStats : public ISimulateClass {
public:
    android_view_FrameStats(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_FRAMESTATS_H

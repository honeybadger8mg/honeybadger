...
#ifndef HONEYBADGER_ANDROID_OS_DEBUG_H
#define HONEYBADGER_ANDROID_OS_DEBUG_H

#include "ISimulateClass.h"



class android_os_Debug : public ISimulateClass {
public:
    android_os_Debug(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_DEBUG_H

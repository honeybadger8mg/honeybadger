...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_BYTEBUFFERSTREAMADAPTOR_H
#define HONEYBADGER_ANDROID_GRAPHICS_BYTEBUFFERSTREAMADAPTOR_H
...
class android_graphics_ByteBufferStreamAdaptor : public ISimulateClass {
public:
    android_graphics_ByteBufferStreamAdaptor(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_BYTEBUFFERSTREAMADAPTOR_H

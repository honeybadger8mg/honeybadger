...
#ifndef HONEYBADGER_ANDROID_PROVIDER_SETTINGS_GLOBAL_H
#define HONEYBADGER_ANDROID_PROVIDER_SETTINGS_GLOBAL_H
...
class android_provider_Settings_Global : public ISimulateClass {
public:
    android_provider_Settings_Global(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_PROVIDER_SETTINGS_GLOBAL_H

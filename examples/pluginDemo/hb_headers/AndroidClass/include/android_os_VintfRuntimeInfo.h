...
#ifndef HONEYBADGER_ANDROID_OS_VINTFRUNTIMEINFO_H
#define HONEYBADGER_ANDROID_OS_VINTFRUNTIMEINFO_H
...
class android_os_VintfRuntimeInfo : public ISimulateClass {
public:
    android_os_VintfRuntimeInfo(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_VINTFRUNTIMEINFO_H

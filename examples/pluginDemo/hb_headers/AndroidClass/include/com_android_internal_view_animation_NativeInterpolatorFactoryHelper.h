...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_VIEW_ANIMATION_NATIVEINTERPOLATORFACTORYHELPER_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_VIEW_ANIMATION_NATIVEINTERPOLATORFACTORYHELPER_H
...
class com_android_internal_view_animation_NativeInterpolatorFactoryHelper : public ISimulateClass {
public:
    com_android_internal_view_animation_NativeInterpolatorFactoryHelper(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_VIEW_ANIMATION_NATIVEINTERPOLATORFACTORYHELPER_H

...
#ifndef HONEYBADGER_ANDROID_DATABASE_SQLITEGLOBAL_H
#define HONEYBADGER_ANDROID_DATABASE_SQLITEGLOBAL_H
...
class android_database_SQLiteGlobal : public ISimulateClass {
public:
    android_database_SQLiteGlobal(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_DATABASE_SQLITEGLOBAL_H

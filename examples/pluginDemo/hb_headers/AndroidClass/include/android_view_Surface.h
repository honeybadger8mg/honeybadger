...
#ifndef HONEYBADGER_ANDROID_VIEW_SURFACE_H
#define HONEYBADGER_ANDROID_VIEW_SURFACE_H
...
class android_view_Surface : public ISimulateClass {
public:
    android_view_Surface(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_SURFACE_H

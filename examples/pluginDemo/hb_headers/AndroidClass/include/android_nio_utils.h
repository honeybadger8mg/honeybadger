...
#ifndef HONEYBADGER_ANDROID_NIO_UTILS_H
#define HONEYBADGER_ANDROID_NIO_UTILS_H
...
class android_nio_utils : public ISimulateClass {
public:
    android_nio_utils(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_NIO_UTILS_H

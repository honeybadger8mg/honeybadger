...
#ifndef HONEYBADGER_ANDROID_OS_HIDLSUPPORT_H
#define HONEYBADGER_ANDROID_OS_HIDLSUPPORT_H
...
class android_os_HidlSupport : public ISimulateClass {
public:
    android_os_HidlSupport(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_HIDLSUPPORT_H

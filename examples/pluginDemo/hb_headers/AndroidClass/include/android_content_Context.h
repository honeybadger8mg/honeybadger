...
#ifndef HONEYBADGER_ANDROID_CONTENT_CONTEXT_H
#define HONEYBADGER_ANDROID_CONTENT_CONTEXT_H

#include "ISimulateClass.h"



class android_content_Context : public ISimulateClass {
public:
    android_content_Context(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_CONTENT_CONTEXT_H

...
#ifndef HONEYBADGER_OKHTTP3_HTTPURL_H
#define HONEYBADGER_OKHTTP3_HTTPURL_H
#include "ISimulateClass.h"



class okhttp3_HttpUrl: public ISimulateClass {
public:
    okhttp3_HttpUrl(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_REQUEST_H

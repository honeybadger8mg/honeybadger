...
#ifndef HONEYBADGER_ANDROID_VIEW_SURFACEVIEW_H
#define HONEYBADGER_ANDROID_VIEW_SURFACEVIEW_H
...
class android_view_SurfaceView : public ISimulateClass {
public:
    android_view_SurfaceView(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_SURFACEVIEW_H

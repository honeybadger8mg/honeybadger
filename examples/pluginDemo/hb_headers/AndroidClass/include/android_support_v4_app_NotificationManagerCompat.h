...
#ifndef HONEYBADGER_ANDROID_SUPPORT_V4_APP_NOTIFICATIONMANAGERCOMPAT_H
#define HONEYBADGER_ANDROID_SUPPORT_V4_APP_NOTIFICATIONMANAGERCOMPAT_H
...
class android_support_v4_app_NotificationManagerCompat : public ISimulateClass {
public:
    android_support_v4_app_NotificationManagerCompat(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_SUPPORT_V4_APP_NOTIFICATIONMANAGERCOMPAT_H

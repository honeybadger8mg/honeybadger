...
#ifndef HONEYBADGER_ANDROID_CONTENT_CONTENTRESOLVER_H
#define HONEYBADGER_ANDROID_CONTENT_CONTENTRESOLVER_H

#include "ISimulateClass.h"



class android_content_ContentResolver : public ISimulateClass {
public:
    // 获取实例   并一并处理关联的信息  这个暂时没有需要专门处理的数据
    static android_content_ContentResolver *CreateNew(HB::EntryInterface *pDebugger);
public:
    android_content_ContentResolver(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_CONTENT_CONTENTRESOLVER_H

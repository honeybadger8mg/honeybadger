...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_GRAPHICS_H
#define HONEYBADGER_ANDROID_GRAPHICS_GRAPHICS_H
...
class android_graphics_Graphics : public ISimulateClass {
public:
    android_graphics_Graphics(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_GRAPHICS_H

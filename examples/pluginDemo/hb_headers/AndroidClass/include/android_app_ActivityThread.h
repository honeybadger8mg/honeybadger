...
#ifndef HONEYBADGER_ANDROID_APP_ACTIVITYTHREAD_H
#define HONEYBADGER_ANDROID_APP_ACTIVITYTHREAD_H

#include "ISimulateClass.h"



class android_app_ActivityThread  : public ISimulateClass {
public:
    android_app_ActivityThread(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_ACTIVITYTHREAD_H

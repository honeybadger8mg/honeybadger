...
#ifndef HONEYBADGER_ANDROID_BACKUP_BACKUPDATAOUTPUT_H
#define HONEYBADGER_ANDROID_BACKUP_BACKUPDATAOUTPUT_H
...
class android_backup_BackupDataOutput : public ISimulateClass {
public:
    android_backup_BackupDataOutput(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_BACKUP_BACKUPDATAOUTPUT_H

...
#ifndef HONEYBADGER_JAVA_UTIL_LOCALE_H
#define HONEYBADGER_JAVA_UTIL_LOCALE_H

#include "ISimulateClass.h"



class java_util_Locale : public ISimulateClass {
public:
    java_util_Locale(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_UTIL_LOCALE_H

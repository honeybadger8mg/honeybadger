...
#ifndef HONEYBADGER_ANDROID_MEDIA_MICROPHONEINFO_H
#define HONEYBADGER_ANDROID_MEDIA_MICROPHONEINFO_H
...
class android_media_MicrophoneInfo : public ISimulateClass {
public:
    android_media_MicrophoneInfo(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_MEDIA_MICROPHONEINFO_H

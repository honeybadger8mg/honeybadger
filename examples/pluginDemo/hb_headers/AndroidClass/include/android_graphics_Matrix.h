...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_MATRIX_H
#define HONEYBADGER_ANDROID_GRAPHICS_MATRIX_H
...
class android_graphics_Matrix : public ISimulateClass {
public:
    android_graphics_Matrix(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_MATRIX_H

...
#ifndef HONEYBADGER_ANDROID_DATABASE_CURSORWINDOW_H
#define HONEYBADGER_ANDROID_DATABASE_CURSORWINDOW_H
...
class android_database_CursorWindow : public ISimulateClass {
public:
    android_database_CursorWindow(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_DATABASE_CURSORWINDOW_H

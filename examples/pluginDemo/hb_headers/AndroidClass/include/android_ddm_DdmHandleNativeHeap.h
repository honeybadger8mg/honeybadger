...
#ifndef HONEYBADGER_ANDROID_DDM_DDMHANDLENATIVEHEAP_H
#define HONEYBADGER_ANDROID_DDM_DDMHANDLENATIVEHEAP_H
...
class android_ddm_DdmHandleNativeHeap : public ISimulateClass {
public:
    android_ddm_DdmHandleNativeHeap(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_DDM_DDMHANDLENATIVEHEAP_H

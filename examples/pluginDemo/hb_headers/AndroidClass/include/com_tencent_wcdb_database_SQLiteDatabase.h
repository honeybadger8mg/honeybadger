...
#ifndef HONEYBADGER_COM_TENCENT_WCDB_DATABASE_SQLITEDATABASE_H
#define HONEYBADGER_COM_TENCENT_WCDB_DATABASE_SQLITEDATABASE_H
...
class com_tencent_wcdb_database_SQLiteDatabase : public ISimulateClass {
public:
    com_tencent_wcdb_database_SQLiteDatabase(HB::EntryInterface *pDebugger);
    ...
    uint32_t ToReflectedMethod(uint32_t iMtdID);
private:
...
#endif //HONEYBADGER_COM_TENCENT_WCDB_DATABASE_SQLITEDATABASE_H

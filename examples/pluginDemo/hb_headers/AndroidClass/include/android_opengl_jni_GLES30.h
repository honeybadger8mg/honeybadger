...
#ifndef HONEYBADGER_ANDROID_OPENGL_JNI_GLES30_H
#define HONEYBADGER_ANDROID_OPENGL_JNI_GLES30_H
...
class android_opengl_jni_GLES30 : public ISimulateClass {
public:
    android_opengl_jni_GLES30(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OPENGL_JNI_GLES30_H

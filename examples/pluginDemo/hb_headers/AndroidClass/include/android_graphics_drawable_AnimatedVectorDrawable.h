...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_ANIMATEDVECTORDRAWABLE_H
#define HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_ANIMATEDVECTORDRAWABLE_H
...
class android_graphics_drawable_AnimatedVectorDrawable : public ISimulateClass {
public:
    android_graphics_drawable_AnimatedVectorDrawable(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_ANIMATEDVECTORDRAWABLE_H

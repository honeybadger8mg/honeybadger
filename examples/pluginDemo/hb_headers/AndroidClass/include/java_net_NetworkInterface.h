...
#ifndef HONEYBADGER_JAVA_NET_NETWORKINTERFACE_H
#define HONEYBADGER_JAVA_NET_NETWORKINTERFACE_H

#include "ISimulateClass.h"



class java_net_NetworkInterface : public ISimulateClass {
public:
    java_net_NetworkInterface(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_NET_NETWORKINTERFACE_H

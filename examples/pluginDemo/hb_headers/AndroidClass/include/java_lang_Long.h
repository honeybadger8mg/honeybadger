...
#ifndef HONEYBADGER_JAVA_LANG_LONG_H
#define HONEYBADGER_JAVA_LANG_LONG_H

#include "ISimulateClass.h"



class java_lang_Long : public ISimulateClass {
public:
    java_lang_Long(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_LONG_H

...
#ifndef HONEYBADGER_ANDROID_MEDIA_AUDIOSYSTEM_H
#define HONEYBADGER_ANDROID_MEDIA_AUDIOSYSTEM_H
...
class android_media_AudioSystem : public ISimulateClass {
public:
    android_media_AudioSystem(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_MEDIA_AUDIOSYSTEM_H

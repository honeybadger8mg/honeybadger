...
#ifndef HONEYBADGER_ANDROID_OS_SYSTEMCLOCK_H
#define HONEYBADGER_ANDROID_OS_SYSTEMCLOCK_H

#include "ISimulateClass.h"



class android_os_SystemClock : public ISimulateClass {
public:
    android_os_SystemClock(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_OS_SYSTEMCLOCK_H

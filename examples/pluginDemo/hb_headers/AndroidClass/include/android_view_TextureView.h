...
#ifndef HONEYBADGER_ANDROID_VIEW_TEXTUREVIEW_H
#define HONEYBADGER_ANDROID_VIEW_TEXTUREVIEW_H
...
class android_view_TextureView : public ISimulateClass {
public:
    android_view_TextureView(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_TEXTUREVIEW_H

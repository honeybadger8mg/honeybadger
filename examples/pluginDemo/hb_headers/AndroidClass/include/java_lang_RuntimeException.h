...
#ifndef HONEYBADGER_JAVA_LANG_RUNTIMEEXCEPTION_H
#define HONEYBADGER_JAVA_LANG_RUNTIMEEXCEPTION_H
...
class java_lang_RuntimeException : public ISimulateClass {
public:
    java_lang_RuntimeException(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_RUNTIMEEXCEPTION_H

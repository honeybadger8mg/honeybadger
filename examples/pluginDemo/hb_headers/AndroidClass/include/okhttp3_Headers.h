...
#ifndef HONEYBADGER_OKHTTP3_HEADERS_H
#define HONEYBADGER_OKHTTP3_HEADERS_H

#include "ISimulateClass.h"


class okhttp3_Headers : public ISimulateClass {
public:
    okhttp3_Headers(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_OKHTTP3_HEADERS_H

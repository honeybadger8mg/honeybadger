...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_MOVIE_H
#define HONEYBADGER_ANDROID_GRAPHICS_MOVIE_H
...
class android_graphics_Movie : public ISimulateClass {
public:
    android_graphics_Movie(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_MOVIE_H

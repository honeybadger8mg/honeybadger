...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_DRAWFILTER_H
#define HONEYBADGER_ANDROID_GRAPHICS_DRAWFILTER_H
...
class android_graphics_DrawFilter : public ISimulateClass {
public:
    android_graphics_DrawFilter(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_DRAWFILTER_H

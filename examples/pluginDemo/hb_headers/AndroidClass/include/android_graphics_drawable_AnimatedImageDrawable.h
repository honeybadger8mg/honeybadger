...
#ifndef HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_ANIMATEDIMAGEDRAWABLE_H
#define HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_ANIMATEDIMAGEDRAWABLE_H
...
class android_graphics_drawable_AnimatedImageDrawable : public ISimulateClass {
public:
    android_graphics_drawable_AnimatedImageDrawable(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_GRAPHICS_DRAWABLE_ANIMATEDIMAGEDRAWABLE_H

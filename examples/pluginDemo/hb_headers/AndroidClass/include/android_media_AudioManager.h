...
#ifndef HONEYBADGER_ANDROID_MEDIA_AUDIOMANAGER_H
#define HONEYBADGER_ANDROID_MEDIA_AUDIOMANAGER_H
...
class android_media_AudioManager : public ISimulateClass {
public:
    android_media_AudioManager(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_MEDIA_AUDIOMANAGER_H

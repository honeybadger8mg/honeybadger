...
#ifndef HONEYBADGER_ANDROID_APP_ACTIVITYMANAGERNATIVE_H
#define HONEYBADGER_ANDROID_APP_ACTIVITYMANAGERNATIVE_H

#include "ISimulateClass.h"



class android_app_ActivityManagerNative  : public ISimulateClass {
public:
    android_app_ActivityManagerNative(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_APP_ACTIVITYMANAGERNATIVE_H

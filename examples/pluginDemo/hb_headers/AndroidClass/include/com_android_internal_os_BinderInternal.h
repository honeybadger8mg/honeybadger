...
#ifndef HONEYBADGER_COM_ANDROID_INTERNAL_OS_BINDERINTERNAL_H
#define HONEYBADGER_COM_ANDROID_INTERNAL_OS_BINDERINTERNAL_H
...
class com_android_internal_os_BinderInternal : public ISimulateClass {
public:
    com_android_internal_os_BinderInternal(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_COM_ANDROID_INTERNAL_OS_BINDERINTERNAL_H

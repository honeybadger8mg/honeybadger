...
#ifndef HONEYBADGER_ANDROID_VIEW_SURFACECONTROL_PHYSICALDISPLAYINFO_H
#define HONEYBADGER_ANDROID_VIEW_SURFACECONTROL_PHYSICALDISPLAYINFO_H
...
class android_view_SurfaceControl_PhysicalDisplayInfo : public ISimulateClass {
public:
    android_view_SurfaceControl_PhysicalDisplayInfo(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_ANDROID_VIEW_SURFACECONTROL_PHYSICALDISPLAYINFO_H

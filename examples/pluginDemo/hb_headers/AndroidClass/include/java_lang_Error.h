...
#ifndef HONEYBADGER_JAVA_LANG_ERROR_H
#define HONEYBADGER_JAVA_LANG_ERROR_H
...
class java_lang_Error : public ISimulateClass {
public:
    java_lang_Error(HB::EntryInterface *pDebugger);
...
#endif //HONEYBADGER_JAVA_LANG_ERROR_H
